			...
			<div class="main_visual">
				...
				<div class="swiper-container"> 
					<div class="swiper-wrapper"> 
						...
						?>
						<?if (mysql_result($arr_Bann_Data,$int_J,str_image1)!="") {?>
						<div class="swiper-slide" id="mvisual<?=Fnc_Om_Add_Zero($int_J,2)?>"></div> 
						<?}?>
						<?
							}
						?>
			...
			<div class="main01">
				<div class="contents_w">
						...
						<div class="m_brand">
							...
							<div class="m_brand_in">
								<ul>
									...
									?>
									<li>
										<div class="brand_logo"><p><?if (mysql_result($arr_Bann_Data,$int_J,str_image1)!="") {?><img src="/admincenter/files/com/<?=mysql_result($arr_Bann_Data,$int_J,str_image1)?>" alt="" /><?}?></p></div>
										<div class="brand_name"><p><?=mysql_result($arr_Bann_Data,$int_J,str_code)?></p></div>
										<?if (($int_J+7)%7==0) {?>
										<i></i>
										<?}?>
									</li>
					...
					<div id="n2tab04" style="display:none;">
						...
						<ul class="faq_list">
							<li class="q"><a href="#;">신청 후 가방을 받았는데, 다른 가방이 왔습니다.</a> </li>
							<li class="q"><a href="#;">신청 후 가방을 받았는데, 다른 가방이 왔습니다.</a> </li>
							<li class="a">죄송합니다. 바로 교환 처리해 드리겠습니다.  <br />혹 다른 상품을 받으셨더라도 단종 상품이라면  입고가 더 이상 없으며, 일시 품절 상품이라면 입고일까지 기다리셔야 합니다.<br />불편을 끼쳐 죄송합니다.</li>
							<li class="q"><a href="#;">신청 후 가방을 받았는데, 다른 가방이 왔습니다.</a> </li>
							<li class="q"><a href="#;">신청 후 가방을 받았는데, 다른 가방이 왔습니다.</a> </li>
						</ul>
					</div>
					...
					<div class="item_list02">
						...
						$SQL_QUERY = "SELECT 
													A.*,
													(SELECT C.STR_BCODE FROM ".$Tname."comm_goods_master_category B WHERE A.STR_GOODCODE=B.STR_GOODCODE LIMIT 1) AS STR_BCODE,
						...
						<div id="layout">
							...
							<div class="item">
								...
								<p class="item_img" style="width:320px;height:320px;"><?if (mysql_result($arr_Data,$int_J,str_image1)!="") {?><img src="/admincenter/files/good/<?=mysql_result($arr_Data,$int_J,str_image1)?>" style="width:320px;height:320px;" border="0"><?}?></p>
								<dl>
									<dt><a href="/category/detail.php?Txt_bcode=<?=mysql_result($arr_Data,$int_J,str_bcode)?>&str_no=<?=mysql_result($arr_Data,$int_J,str_goodcode)?>"><?=mysql_result($arr_Data,$int_J,str_goodname)?></a></dt>
									<dd><?=mysql_result($arr_Data,$int_J,str_egoodname)?></dd>
								</dl>
								<div class="caption" style="display: none;">
									<p class="item_img" style="width:320px;height:320px;"><a href="/category/detail.php?Txt_bcode=<?=mysql_result($arr_Data,$int_J,str_bcode)?>&str_no=<?=mysql_result($arr_Data,$int_J,str_goodcode)?>"><?if (mysql_result($arr_Data,$int_J,str_image2)!="") {?><img src="/admincenter/files/good/<?=mysql_result($arr_Data,$int_J,str_image2)?>" style="width:320px;height:320px;" border="0"><?}?></a></p>
									<?If ($arr_Auth[0]=="") {?>
										<p class="on_btn mt20"><a href="javascript:Cart_Click('<?=mysql_result($arr_Data,$int_J,str_goodcode)?>');" class="btn btn_get">GET</a></p>
									<?}else{?>
										<?if ($sBuy > 0) {//구매가 있을때?>
											<?if ($sRent!=0) {//품절이 아닐때?>
												...
												<?}else{?>
													<p class="on_btn mt20"><a href="javascript:Cart_Click('<?=mysql_result($arr_Data,$int_J,str_goodcode)?>');" class="btn btn_get">CHANGE</a></p>
												<?}?>
											<?}else{?>
			...
			<div class="main02 mt35">
				<div class="contents_w">
					<div class="m_use_info">
						...
						<dl class="mui02">
							<dt>정품 인증</dt>
							<dd>모든 가방은 백화점 및 매장에서 <span>직접 구매한 100% 정품입니다.</span> 안심하고 사용하세요.</dd>
						</dl>
						<dl class="mui03">
							<dt>반납 및 교환</dt>
							<dd>언제든 원하는 가방으로 <span>CHANGE 신청하세요.</span>현재 사용중인 가방의 반납이 <span>확인되는 즉시 새로 선택한 가방이</span> 발송됩니다.</dd>
						</dl>
						<dl class="mui04">
							<dt>배송</dt>
							<dd>오전 11시 이전 GET한 가방은 <span>당일 출고됩니다.</span>(왕복배송비 월 2회 무료)</dd>
						</dl>
						<dl class="mui05">
							<dt>생활 스크래치 안심보험 </dt>
							<dd>에이블랑은 고객이 상품을 <span>안심하고 사용할 수 있도록</span> ‘생활스크래치 안심보험’을 <span>제공하고 있습니다</span></dd>
						</dl>
					</div>
				</div>
			</div>
