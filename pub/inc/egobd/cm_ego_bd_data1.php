	...
	<!--
		function fnc_View_File(pr_Perc, pr_Use, pr_Perm, pr_Lbl)
		{
			...
			var str_View_Html =	'<table border="0" cellpadding="0" cellspacing="0" width="100%">'+
								'<tr>'+
								'<td width="50%" style="padding:0px;border-bottom:0px;">'+
									'<table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td bgcolor="#DDDDDD" height="10" style="padding:0px;border-bottom:0px;">'+
									'<table border="0" cellpadding="0" cellspacing="0" style="width:'+int_Use_Per+'%" height="100%">'+
										'<tr><td bgcolor="#0075BB" style="padding:0px;border-bottom:0px;"></td></tr>'+
									'</table>'+
									'</td></tr></table>'+
								'</td>'+
								'<td width="50%" style="font-size:8pt;padding:0px;border-bottom:0px;">&nbsp;'+str_Use_Amt+" /"+str_Perm_Amt+'</td>'+
								'</tr>'+
								'</table>';
