...
//		$Headers .= "Content-Type: text/html;"; 
	...
	function fnc_card_kind($str_card) {
		...
		switch ($str_card) {
			case  "CCKM" : echo "국민카드"; break;
			case  "CCNH" : echo "NH농협카드"; break;
			case  "CCSG" : echo "신세계한미"; break;
			case  "CCCT" : echo "씨티카드"; break;
			case  "CCHM" : echo "한미카드"; break;
			case  "CVSF" : echo "해외비자"; break;
			case  "CCAM" : echo "롯데아멕스카드"; break;
			case  "CCLO" : echo "롯데카드"; break;
			case  "CCBC" : echo "BC카드"; break;
			case  "CCBC" : echo "우리카드"; break;
			case  "CCHN" : echo "하나SK카드"; break;
			case  "CCSS" : echo "삼성카드"; break;
			case  "CCKJ" : echo "광주카드"; break;
			case  "CCSU" : echo "수협카드"; break;
			case  "CCBC" : echo "신협카드"; break;
			case  "CCJB" : echo "전북카드"; break;
			case  "CCCJ" : echo "제주카드"; break;
			case  "CCLG" : echo "신한카드"; break;
			case  "CMCF" : echo "해외마스터"; break;
			case  "CJCF" : echo "해외JCB"; break;
			case  "CCKE" : echo "외환카드"; break;
			case  "CCBC" : echo "현대증권카드"; break;
			case  "CCDI" : echo "현대카드"; break;
			case  "CCBC" : echo "저축카드"; break;
			case  "CCBC" : echo "산업카드"; break;
			case  "CCUF" : echo "은련카드"; break;
		}
