	...
	*/
	...
	var s_Sys_Url = "/pub/";
	var str_Pub_Files = s_Sys_Url;

	var str_Icon_Path = str_Pub_Files+"editor/img/";		// --- 아이콘 이미지 경로
	var str_With_Path = str_Pub_Files+"editor/";			// --- 관련 브라우저 경로
	...
	document.write(".mtx_Css{textarea{font-size:10pt;border-width:1px;border-style:solid;background-image:url("+str_Icon_Path+"line.gif);background-repeat:repeat;background-position:left top;background-attachment:scroll;font-family:돋움;}");
	document.write("</style>");
	...
	arr_Edit_Icon[27] = new Array(str_Icon_Path + "ed_print.gif", 'fncPrintMode();', '인쇄하기');
	...
	function fncConvText(strVal, type)
	{
		...
		var regSpanH = new RegExp("(<SPAN[^<]*>)","gi");
		var regSpanT = new RegExp("(<\/SPAN>)","gi");
		strVal = strVal.replace(regSpanH, "");
		strVal = strVal.replace(regSpanT, "");
