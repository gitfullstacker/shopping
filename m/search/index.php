                ...
                <template x-if="showOption == 2">
                    <div class="w-full h-[52px] flex justify-start items-center">
                        <div class="relative w-full">
                            <input type="text" class="w-full h-[38px] bg-[#F8F8F8] border border-solid border-[#E0E0E0] rounded-[4px] pl-3 pr-7 font-bold text-xs leading-[14px] placeholder:text-[#C4C4C4]" name="" id="brand_search" placeholder="브랜드를 검색하세요" x-model="content[showOption].searchKey">
                            ...
                            <div class="w-full h-[52px] flex justify-start gap-[5px] items-center border-b border-[#E0E0E0] flex-none" x-on:click="selectItem(index);">
                                ...
                                <template x-if="showOption != 1">
                                    <div class="flex flex-col gap-[1.8px]">
                                        ...
                                        <label class="font-bold text-[10px] leading-[11px] text-[#9D9D9D]" x-text="item.ktitle">발렌시아가</label>
                                    </div>
                                </template>
                            </div>
                        </template>
