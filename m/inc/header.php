...
<body>
	...
	<div class="header-mobile">
		...
		if ($search_menu) {
		?>
			<div class="px-[12.5px] py-[13px] w-full">
				<div class="relative w-full">
					<input type="text" class="w-full h-[38px] bg-[#F8F8F8] border border-solid border-[#E0E0E0] rounded-[4px] pl-3 pr-7 font-bold text-xs leading-[14px] placeholder:text-[#C4C4C4]" name="" id="top_search" placeholder="검색어를 입력해주세요.">
		...
		?>
			<div class="header-content">
				...
				<div class="menu">
					...
					<a href="/m/subscription/" class="menu-item">명품구독</a>
					<a href="/m/used/" class="menu-item">홈중고명품</a>
					<a href="/boad/bd_news/m1/egolist.php?bd=3&itm=&txt=&pg=1" class="menu-item">이벤트존</a>
				</div>
			</div>
		<?php
		}
	...
	<div id="wrapper" style="<?= $search_menu ? 'margin-top: 102.58px;' : '' ?>">