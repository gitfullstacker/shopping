...
<div class="flex flex-col w-full">
    ...
    <div class="flex flex-col w-full mt-[30px] px-[14px]">
        <div class="flex justify-between">
            <!-- 타그 -->
            <div class="flex justify-center items-center px-1.5 py-1 bg-[#EEAC4C]">
                <p class="font-normal text-[10px] text-center text-white">구독</p>
            </div>
            <!-- Like -->
        ...
        <p class="mt-[9px] font-extrabold text-xs text-[#666666]">BOTTEGA VENETA</p>
        <p class="mt-[5px] font-extrabold text-lg text-[#333333]">카세트백 스몰</p>
        <p class="mt-[15px] font-bold text-xs text-[#666666]">카세트백 스몰</p>
        <p class="mt-[7px] font-extrabold text-lg text-[#333333]"><span class="text-[#EEAC4C]">월</span> 27,000원</p>
    </div>

    <!-- 프리미엄 멤버십 (정기결제) -->
    <div class="mt-4 flex w-full px-[14px]">
        <div class="flex flex-col gap-2.5 w-full bg-[#FFF3E1] border border-solid border-[#DDDDDD] p-[14px]">
            <div class="flex flex-row gap-1.5 items-center">
                <input type="checkbox" class="w-4 h-4 bg-white border-[0.72px] border-solid border-[#DDDDDD]" name="" id="">
                <div class="flex gap-2 items-center">
                    <span class="font-extrabold text-[15px] text-black">프리미엄 멤버십</span>
                    <span class="font-bold text-xs text-[#666666]">(정기결제)</span>
                </div>
            </div>
            <button class="flex justify-center items-center w-full h-10 bg-[#EEAC4C]">
                <span class="font-bold text-sm text-white">정기구독 월 89,000원</span>
            </button>
        </div>
    </div>
