...
<div class="flex justify-center items-center h-[57px] border-b-[0.5px] border-[#E0E0E0] relative">
    ...
    <p class="font-extrabold text-xl leading-[22px] text-[#333333]"><?= $arr_Data['INT_TYPE'] == 1 ? 'EVENT' : 'NEWS LETTER' ?></p>
</div>
...
<div class="flex flex-col w-full">
    <div class="flex flex-col gap-[9px] px-[14px] py-5">
        ...
        <p class="font-semibold text-xs leading-[14px] text-[#333333]"><?= $arr_Data['STR_STITLE'] ?></p>
    </div>

    <div class="mt-5 flex w-full">
        <p class="font-semibold text-xs leading-[14px] text-[#333333]">
            <?= $arr_Data['STR_CONT'] ?>
        </p>
    </div>
