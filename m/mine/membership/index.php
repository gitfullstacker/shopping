...
<div class="mt-[30px] flex flex-col items-center w-full px-[14px]">
    ...
    <div class="flex flex-col items-center w-full">
        <p class="font-extrabold text-lg leading-5 text-black">구독 멤버십 내역</p>
        <div class="mt-[22px] w-[210px] h-[140px] flex flex-col justify-center items-center bg-[#F5F5F5] border border-solid border-[#DDDDDD] rounded-[10px]">
