                ...
                ?>
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            <a href="/m/mine/question/create.php?int_cart=<?= $arr_Data['INT_NUMBER'] ?>&int_type=12" class="w-full h-10 flex justify-center items-center bg-white border border-solid border-[#DDDDDD] rounded-[3px]">
...
<div id="return_dialog" class="w-full bg-black bg-opacity-60 fixed bottom-[66px] z-50 flex justify-center items-start max-w-[410px] hidden" style="height: calc(100vh - 66px);">
    <div class="mt-[60%] flex flex-col gap-[11px] items-center justify-center rounded-lg bg-white w-[80%] relative px-4 py-[35px]">
        ...
        <div x-data="{
            ...
            }" class="w-[144px] h-[30px] flex justify-center items-center bg-white border-[0.72px] border-solid border-[#DDDDDD] relative" x-on:click="showSelectPanel = true" x-on:click.outside="showSelectPanel = false">
            <div class="flex gap-[18px] items-center cursor-pointer">
