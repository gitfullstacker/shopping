...
$Sql_Query = "INSERT INTO `" . $Tname . "comm_member_qna` (STR_MUSERID, INT_IDX, INT_ORDER, INT_LEVEL, STR_USERID, STR_NAME, STR_CONT, STR_IMAGE1, DTM_INDATE, STR_TITLE) VALUES ('" . $arr_Auth[0] . "', LAST_INSERT_ID(), NULL, 0, '" . $arr_Auth[0] . "', '', '" . $_POST['str_cont'] . "', '" . $str_Temp[1][0] . "', '" . date("Y-m-d H:i:s") . "', '" . $_POST['str_title'] . "') ";
