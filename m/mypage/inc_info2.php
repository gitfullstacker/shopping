			...
			<!--<p class="mt10">* 정기권을 신청하신 회원은 매회 자동결제가 됩니다</p>//-->
...
<link href="/kcp/mobile/css/style.css" rel="stylesheet" type="text/css" id="cssLink"/>

<!-- 거래등록 하는 kcp 서버와 통신을 위한 스크립트-->
<script type="text/javascript" src="/kcp/mobile/js/approval_key.js"></script>

<script type="text/javascript">
  var controlCss = "/kcp/mobile/css/style_mobile.css";
  var isMobile = {
    Android: function() {
...
<form name="pay_form" method="post" action="inc_info2_proc.php">
...
<script language="javascript">jsf__chk_type();init_orderid();chk_pay();</script>