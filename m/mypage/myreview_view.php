...
<? require_once $_SERVER[DOCUMENT_ROOT]."/m/inc/header.php"; ?>
		...
		<div class="con_width">
			...
			<div class="btn_w mt15">
				<p class="fl3_1"><a href="#;" class="btn btn_l btn_ylw f_bd w100p">수정하기</a></p>
				<p class="fl3_2"><a href="#;" class="btn btn_l btn_bk f_bd w100p">삭제</a></p>
				<p class="fl3_3"><a href="#;" class="btn btn_l btn_bk f_bd w100p">목록</a></p>
			</div>
