...
<script language="javascript" src="js/like.js"></script>
		...
		<div class="con_width">
			...
			<div class="tit_h2 pt15">
				<em>좋아요 가방</em>
				<span class="tit_h2_desc">고객님께서 좋아요를 누르신 가방입니다. </span>
			</div>

			<ul class="new_list mt15" id="labData">
				<?$count=0;?>
			...
			<?if($total_record_limit!=0){?>
			<p><a href="javascript:fnc_more();" class="btn btn_readmore" style="margin-bottom: 15px;">READ MORE <i class="icn"></i></a></p>
			<?}?>
		</div>
