    ...
    <div class="review-detail">
        <div class="product-detail">
            ...
            <div class="information">
                <div class="tag">
                    <div class="value">렌트</div>
                </div>
                <div class="brand">CHANEL</div>
                <div class="title">코코핸들 스몰</div>
                <div class="score">★★★★★</div>
            </div>
        </div>
        <div class="spliter"></div>
        <div class="image">
            <img src="../images/mockup/review1.png" alt="">
        </div>
        <div class="content">
            ...
            <p class="description">
                가방 너무 이뻐요~ 역시 샤넬은 기다린 보람이 있어요!
                멤버십 할인도 받아서 저렴하게 렌트했어요 :)
                정가주고 사기에도 비싸고 구하기도 힘든 가방이라 언제나 위시였는데
                이렇게 좋은 서비스를 에이블랑을 통해서 알게되어 너무 좋아요!!
                주변에도 에이블랑 홍보하고 다녀야겠어요~
            </p>
        </div>
    </div>
</div>