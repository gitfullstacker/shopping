...
$str_telep = Fnc_Om_Conv_Default($_REQUEST[same_account], "") == "1" ? $str_hp : Fnc_Om_Conv_Default($_REQUEST[str_telep1], "") . "-" . Fnc_Om_Conv_Default($_REQUEST[str_telep2], "") . "-" . Fnc_Om_Conv_Default($_REQUEST[str_telep3], "");
