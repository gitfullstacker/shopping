	function Click_like(str_goodcode,loc) {
		...
		if (mTemp[0]=="1") {
			...
			window.location.href="/m/mypage/like.php";
			return;		
		}
	...
	function Alarm_Click(str_goodcode) {
		...
		if(mTemp[0]=="0") {
			...
			if (mTemp[0]=="-1") {
				...
				document.location.href="/m/mypage/stocked.php";
				return;
			}else{
				npopupLayer('alram_pop.php?str_goodcode='+str_goodcode+'&Tcnt='+mTemp[1], 480, 298);
				return;		
			}
		}
