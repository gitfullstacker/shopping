...
$SQL_QUERY = 'SELECT 
                ...
                WHERE 
                    ...
                    AND A.INT_GOOD_TYPE=' . $int_good_type;
    ...
    $result .= '
        <div class="flex flex-col gap-[9px] pb-[15px] border-b-[0.5px] border-[#E0E0E0]">
            <div class="flex justify-between items-center">
                ...
                <button class="flex justify-center items-center gap-[2.76px] w-10 h-[17px] rounded-full border-[0.68px] border-solid border-[#DDDDDD]" onclick="setLike(' . $row['INT_NUMBER'] . ')">
