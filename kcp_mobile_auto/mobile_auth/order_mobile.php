...
<body onload="init_orderid();chk_pay();kcp_AJAX();" style="display: none;">
    <div id="sample_wrap">
        <form name="order_info" method="post">
            ...
            <div class="sample">
                ...
                <table class="tbl" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <th>주문자명</th>
                        <td><input type="text" name="buyr_name" class="w100" value="<?= iconv('UTF-8', 'EUC-KR', $_POST['buyr_name']) ?>"></td>
                    </tr>
                    <tr>
                        <th>E-mail</th>
                        <td><input type="text" name="buyr_mail" class="w200" value="<?= iconv('UTF-8', 'EUC-KR', $_POST['buyr_mail']) ?>"></td>
                    </tr>
                    <tr>
                        <th>전화번호</th>
                        <td><input type="text" name="buyr_tel1" class="w100" value="<?= iconv('UTF-8', 'EUC-KR', $_POST['buyr_tel1']) ?>"></td>
                    </tr>
                    <tr>
                        <th>휴대폰번호</th>
                        <td><input type="text" name="buyr_tel2" class="w100" value="<?= iconv('UTF-8', 'EUC-KR', $_POST['buyr_tel2']) ?>"></td>
                    </tr>
