		...
		<div id="container">
			...
			<input type="hidden" name="str_repay" value="<?=$str_repay?>">
						...
						<tbody>
							<tr style="background-color:#EAEBEE; "></tr>
								...
								<td>
									...
									<p><?if ($arr_Data['INT_OPRICE1']!="0"){?><?}?> <span class="f_bk" style="padding-left:20px; font-size:23px;">￦<?=number_format($arr_Data['INT_PRICE1'])?><echo style="font-size:15px;">/월</span> </p>
				...
				<div style="background-color:#EAEBEE; width:1100px; height:10px; "></div>
					<div class="f_size_s" text align="center" style="background-color:#EAEBEE; font-size:12px; width:1100px; height:10px;"> # 정기권 구독 후 1개월을 이용하실 경우 1개월권 요금 및 혜택이 적용됩니다</div>
				...
				<div class="center" style="background-color:#EAEBEE; width:1100px;" >
					<a href="javascript:<?if (Fnc_Om_Store_Info(14)=="1") {?>Save_Click();<?}else{?>alert('구독권 구독이 현재 불가능합니다.\n관리자에게 문의바랍니다.');<?}?>" class="btn btn_l btn_bk w w270 f_bd">구독하기</a>
				</div>
