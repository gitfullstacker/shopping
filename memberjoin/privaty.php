		...
		<div id="container">
			...
			<div class="sub_container">
				<div class="contents_w">
					<p class="nav_a">HOME   >   MEMBER JOIN    >   개인정보취급방침</p>
					<div class="lnb_tab lnb_tab5 mt20">
						<ul>
							...
							<li class="on"><a href="privaty.php">개인정보취급방침</a></li>
						</ul>
					</div>
					<script>
						function autosize(){
					...
					<iframe src="privaty_txt.html" id="clause01" frameborder="0" width="100%" height="100%" scrolling="no" onload="autosize()"></iframe>
