...
<?
	...
	$SQL_QUERY.=$Tname;
	$SQL_QUERY.="comm_newsle_info a where a.int_number is not null ";
	$SQL_QUERY.=$Str_Query;
...
<script language="javascript" src="js/news_news_list.js"></script>
</head>
<body class=scroll>
			...
			<table width=100%>
				<tr>
					<td style="padding:10px">
						...
						<form id="frm" name="frm" target="_self" method="POST" action="news_news_list.php">
						...
						<table class=tb>
							...
							<tr>
								<td>이메일</td>
								<td colspan="3">
									<input type="text" NAME="Txt_email" value="<?=$Txt_email?>" style="width:300px;">
								</td>
							</tr>
							<tr>
								<td>등록일자</td>
						...
						<table width=100% cellpadding=0 cellspacing=0 border=0>
							...
							<tr height=30 align="center">
								...
								<td><?if (mysql_result($result,$i,str_sex)=="1"){?>남자<?}else{?>여자<?}?></td>
								<td style="text-align:left;"><?=mysql_result($result,$i,str_email)?></td>
