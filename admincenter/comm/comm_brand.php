...
<?
	...
	$SQL_QUERY.=$Tname;
	$SQL_QUERY.="comm_com_code a where a.int_number is not null and a.int_gubun='2' ";
	$SQL_QUERY.=$Str_Query;
	...
	$SQL_QUERY.="where a.int_number is not null and a.int_gubun='2' ";
	$SQL_QUERY.=$Str_Query;
...
<script language="javascript">
	function fnc_good(int_brand,str_brand) {
		parent.document.<?=$obj1?>.<?=$obj2?>.value = int_brand;
		parent.document.<?=$obj1?>.<?=$obj3?>.value = str_brand;
		parent.closeLayer();
	}
	function fnc_search() {
		document.frm.page.value=1;
		document.frm.action = "comm_brand.php";
		document.frm.submit();
	}
</script>
</head>
					...
					<td style="padding:10px">
						...
						<table width=100% cellpadding=0 cellspacing=0 border=0>
							...
							<tr height=30 align="center">
								...
								<td class="noline"><a href="javascript:fnc_good('<?=mysql_result($result,$i,int_number)?>','<?=mysql_result($result,$i,str_code)?>')"><img src="/admincenter/img/i_add.gif"></a></td>
							</tr>
