...
;
			...
			<script language="javascript">
				parent._TreeView.location.href='code_vi_road.php?str_menutype=<?=$str_menutype?>&str_chocode=<?=$BtmCho?>&str_unicode=<?=$BtmUni?>';
				parent.fuc_set('code_input_road.php?RetrieveFlag=UPDATE&str_menutype=<?=$str_menutype?>&str_chocode=<?=$BtmCho?>&str_unicode=<?=$BtmUni?>','_Incode');
     	...
     	case "UPDATE" :
			...
			?>
			<script language="javascript">
				parent._TreeView.location.href='code_vi_road.php?str_menutype=<?=$str_menutype?>&str_chocode=<?=$str_chocode?>&str_unicode=<?=$str_unicode?>';
				parent.fuc_set('code_input_road.php?RetrieveFlag=UPDATE&str_menutype=<?=$str_menutype?>&str_chocode=<?=$str_chocode?>&str_unicode=<?=$str_unicode?>','_Incode');
				parent.table_design_load();
			</script>
			<?
     	...
     	case "DELETE" :
			...
			if ($str_btmcode=="00000") {
				...
				?>
				<script language="javascript">
					parent._TreeView.location.href='code_vi_road.php?str_menutype=<?=$str_menutype?>&str_chocode=<?=$str_chocode?>&str_unicode=<?=$str_topcode?>';
					...
					if($rcd_cnt){?>
					parent.fuc_set('code_input_road.php?RetrieveFlag=UPDATE&str_menutype=<?=$str_menutype?>&str_chocode=<?=$str_chocode?>&str_unicode=<?=$str_topcode?>','_Incode');
					parent.table_design_load();
					<?}else{?>
					parent.fuc_set('code_input_road.php?RetrieveFlag=INSERT&str_menutype=<?=$str_menutype?>&str_chocode=00&str_unicode=00000','_Incode');
					parent.table_design_load();
					<?}?>
