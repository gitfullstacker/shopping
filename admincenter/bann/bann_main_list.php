...
$SQL_QUERY .= $Tname;
$SQL_QUERY .= "comm_banner a where a.int_number is not null and a.int_gubun='$int_gubun' ";
$SQL_QUERY .= $Str_Query;
...
<head>
	...
	<script language="javascript" src="js/bann_main_list.js"></script>
</head>
									...
									<? if ($total_record_limit != 0) { ?>
										...
										<? for ($i = 0; $i <= $displayrow - 1; $i++) { ?>
											<tr height=110 align="center">
												...
												<td><? if (mysql_result($result, $i, str_image1) != "") { ?><img src="/admincenter/files/bann/<?= mysql_result($result, $i, str_image1) ?>" style="width:300px;"><? } ?></td>
												<td>
												...
												<td>
													<?php
													// 카테고리 픽
													if (mysql_result($result, $i, int_gubun) == 10) {
														switch (mysql_result($result, $i, int_type)) {
															case 1:
													?>
																<font class=ver81 color=616161>구독</font>
															<?php
																break;
															case 2:
															?>
																<font class=ver81 color=616161>렌트</font>
															<?php
																break;
															case 3:
															?>
																<font class=ver81 color=616161>빈티지</font>
															<?php
																break;
														}
													}
													...
													// 메인 기타
													if (mysql_result($result, $i, int_gubun) == 11) {
														switch (mysql_result($result, $i, int_type)) {
															case 1:
															?>
																<font class=ver81 color=616161>렌트 신규 입고</font>
															<?php
																break;
															case 2:
															?>
																<font class=ver81 color=616161>구독 신규 입고</font>
													<?php
																break;
														}
													}
