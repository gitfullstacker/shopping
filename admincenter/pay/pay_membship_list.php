...
<?
	...
	If ($Txt_name!="") { $Str_Query .= " and d.str_name like '%$Txt_name%' ";}
	...
	$SQL_QUERY.="where a.int_number is not null and a.str_ptype='1' and a.str_pass='0' ";
	$SQL_QUERY.=$Str_Query;
					...
					<td style="padding:10px">
						...
						<table width=100% cellpadding=0 cellspacing=0 border=0>
							...
							<tr height=30 align="center">
								...
								<td><span id="navig" name="navig" m_id="admin" m_no="1"><font color=0074BA><b><?=mysql_result($result,$i,str_name)?></b></font>(<?=mysql_result($result,$i,str_userid)?>)</span></td>
								...
								<td><?=mysql_result($result,$i,str_sdate)?>~<?=mysql_result($result,$i,str_edate)?> <a href="javascript:popupLayer('pay_bill_edit.php?str_no=<?=mysql_result($result,$i,int_number)?>',800,500);"><font color="red">[빌링작업]</font></a></td>
							...
							<tr>
								<td colspan=11 style="padding-top:0px;padding-bottom:5px;">
										<table class=tb>
											<col class=cellC style="width:10%"><col class=cellL style="width:90%">
											<tr>
												<td>관리자메모</td>
												<td style="height:20px;" valign="top"><font class=def><?=str_replace(chr(13),"<br>",Fnc_Om_Conv_Default(mysql_result($result,$i,str_amemo),""))?></td>
											</tr>
										</table>
								</td>
							</tr>
