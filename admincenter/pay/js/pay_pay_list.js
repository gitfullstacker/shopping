function RowClick(str_no, int_type) {
	popupLayer("pay_pay_edit.php?RetrieveFlag=UPDATE&str_no=" + str_no + "&int_type=" + int_type, 800, 500);
}
function AddNew() {
	document.frm.RetrieveFlag.value = "INSERT";
	document.frm.action = "pay_pay_edit.php";
	document.frm.submit();
}
function fnc_search() {
	document.frm.page.value = 1;
	document.frm.action = "pay_pay_list.php";
	document.frm.submit();
}
...
function fnc_Excel() {
	...
	document.frm.action = "pay_pay_excel.php";
	document.frm.submit();
}
