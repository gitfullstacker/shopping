...
<?
	...
	$SQL_QUERY.=$Tname;
	$SQL_QUERY.="comm_popup_info a where a.int_number is not null and a.int_gubun='$int_gubun' ";
	$SQL_QUERY.=$Str_Query;
...
<script language="javascript" src="js/popu_popup_list.js"></script>
</head>
<body class=scroll>
			...
			<table width=100%>
				<tr>
					<td style="padding:10px">
						...
						<form id="frm" name="frm" target="_self" method="POST" action="popu_popup_list.php">
						...
						<table width=100% cellpadding=0 cellspacing=0 border=0>
							...
							<tr height=30 align="center">
								...
								<td><?If (mysql_result($result,$i,str_service)=="Y") {?>출력<?}else{?>미출력<?}?></td>
