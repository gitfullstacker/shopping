...
<?
	...
	$Txt_option = Fnc_Om_Conv_Default($_REQUEST[Txt_option],"");

	$Txt_sindate = Fnc_Om_Conv_Default($_REQUEST[Txt_sindate],"");
	$Txt_eindate = Fnc_Om_Conv_Default($_REQUEST[Txt_eindate],"");

	If ($Txt_option!="") { $Str_Query .= " and a.str_option like '%$Txt_option%' ";}
	...
	$SQL_QUERY.=$Tname;
	$SQL_QUERY.="comm_goods_option_value a where a.int_number is not null and a.str_goodcode='$str_goodcode' and a.int_gubun='$int_gubun' ";
	$SQL_QUERY.=$Str_Query;
	...
	$SQL_QUERY.="where a.int_number is not null and a.str_goodcode='$str_goodcode' and a.int_gubun='$int_gubun' ";
	$SQL_QUERY.=$Str_Query;
...
<script language="javascript" src="js/good_option_value_list.js"></script>
</head>
<body class=scroll>
			...
			<table width=100%>
				<tr>
					<td style="padding:10px">
						...
						<form id="frm" name="frm" target="_self" method="POST" action="good_option_value_list.php">
						...
						<table class=tb>
							...
							<tr>
								<td>옵션값</td>
								<td colspan="3">
									<input type="text" NAME="Txt_option" value="<?=$Txt_option?>" style="width:300px;">
								</td>
							</tr>
							<tr>
								<td>등록일</td>
						...
						<table width=100% cellpadding=0 cellspacing=0 border=0>
							...
							<tr height=30 align="center">
								...
								<td style="text-align:left;"><?=mysql_result($result,$i,str_option)?></td>
