...
<script language="javascript">
	function fnc_good(str_goodcode,str_goodname) {
	...
	function fnc_search() {
		...
		document.frm.action = "good_list.php";
		document.frm.submit();
	}
</script>
</head>
					...
					<td style="padding:10px">
						...
						<table width=100% cellpadding=0 cellspacing=0 border=0>
							...
							<tr height=30 align="center">
								...
								<td class="noline"><a href="javascript:fnc_good('<?=mysql_result($result,$i,str_goodcode)?>','<?=mysql_result($result,$i,str_goodname)?>')"><img src="/admincenter/img/i_add.gif"></a></td>
							</tr>
