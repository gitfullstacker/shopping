...
$str_size = Fnc_Om_Conv_Default($_REQUEST['str_transverse'] . " X " . $_REQUEST['str_width'] . " X " . $_REQUEST['str_height'] . " cm", "");
...
$str_length = Fnc_Om_Conv_Default($_REQUEST[str_length] . " cm", "");
