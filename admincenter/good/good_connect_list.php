...
<?
	...
	$SQL_QUERY = "select ifnull(count(str_sgoodcode),0) as seq from ".$Tname."comm_goods_master_link where str_goodcode = '".$str_goodcode."' " ;
...
<table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
		...
		$SQL_QUERY.=$Tname;
		$SQL_QUERY.="comm_goods_master a inner join ".$Tname."comm_goods_master_link b on a.str_goodcode=b.str_sgoodcode and b.str_goodcode='$str_goodcode' where a.str_goodcode is not null ";
		$SQL_QUERY.=$Str_Query;
		...
		$SQL_QUERY = "select a.*,b.str_sgoodcode ";
		$SQL_QUERY.=" from ";
		$SQL_QUERY.=$Tname;
		$SQL_QUERY.="comm_goods_master a inner join ".$Tname."comm_goods_master_link b on a.str_goodcode=b.str_sgoodcode and b.str_goodcode='$str_goodcode' where a.str_goodcode is not null ";
		$SQL_QUERY.=$Str_Query;
		...
		<td valign=top width="50%" align="center">
			...
			<table width=95% cellpadding=0 cellspacing=0 border=0>
				...
				<tr height=25 align="center">
					...
					<td align=center><a href="javascript:Delete_Click('<?=mysql_result($result,$i,str_sgoodcode)?>')"><img src="/admincenter/img/i_del.gif"></a></td>
				</tr>
				<tr><td height=4 colspan=5></td></tr>
		...
		$SQL_QUERY.=" and a.str_goodcode<>'$str_goodcode' and a.str_goodcode not in (select b.str_sgoodcode from ".$Tname."comm_goods_master_link b where b.str_goodcode='$str_goodcode') ";
		$SQL_QUERY.=$Str_Query;
		$result = mysql_query($SQL_QUERY);
