...
<?
	...
	If ($Txt_brand!="") { $Str_Query .= " and a.int_brand = '$Txt_brand' ";}
						...
						<table width=100% cellpadding=0 cellspacing=0 border=0>
							...
							<tr height=30 align="center">
										...
										<tr>
											...
											<td rowspan="2">
												<?switch (mysql_result($arr_Data,$int_I,str_service)) {
													case  "Y" : echo "[<font color='blue'>출력</font>]"; break;
													case  "N" : echo "[<font color='red'>미출력</font>]"; break;
												}
												?>	
												-
								...
								<td>
									...
									<span id="idView_Link<?=mysql_result($result,$i,str_goodcode)?>"><?=mysql_result($result,$i,cnt2)?>건</span></font> <a href="javascript:popupLayer('good_connect_list.php?str_goodcode=<?=mysql_result($result,$i,str_goodcode)?>',1000,500)"><img src="/admincenter/img/i_add.gif" border=0 align=absmiddle align="right"></a>
									</span>
								</td>
								<td>
