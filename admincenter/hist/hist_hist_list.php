...
<?
	...
	$SQL_QUERY.=$Tname;
	$SQL_QUERY.="comm_history a where a.int_number is not null and a.int_gubun='$int_gubun' ";
	$SQL_QUERY.=$Str_Query;
...
<script language="javascript" src="js/hist_hist_list.js"></script>
</head>
<body class=scroll>
			...
			<table width=100%>
				<tr>
					<td style="padding:10px">
						...
						<form id="frm" name="frm" target="_self" method="POST" action="hist_hist_list.php">
