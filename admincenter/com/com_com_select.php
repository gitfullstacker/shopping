...
<head>
	...
	<script language="javascript" src="js/com_com_select.js"></script>
</head>
				...
				<table width=100%>
					<tr>
						<td style="padding:10px">
							...
							<form id="frm" name="frm" target="_self" method="POST" action="com_com_select.php" enctype="multipart/form-data">
