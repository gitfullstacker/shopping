...
<?
	...
	$SQL_QUERY.=$Tname;
	$SQL_QUERY.="comm_sms_master a where a.int_number is not null ";
	$SQL_QUERY.=$Str_Query;
...
<script language="javascript" src="js/sms_contents_list.js"></script>
</head>
<body class=scroll>
			...
			<table width=100%>
				<tr>
					<td style="padding:10px">
						...
						<form id="frm" name="frm" target="_self" method="POST" action="sms_contents_list.php">
						...
						<table width=100% cellpadding=0 cellspacing=0 border=0>
							...
							<tr height=30 align="center">
								...
								<td style="text-align:left;"><?=mysql_result($result,$i,str_shp)?></td>
								<td style="text-align:left;"><?=mysql_result($result,$i,str_contents)?></td>
