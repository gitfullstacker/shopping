...
$SQL_QUERY .= $Tname;
$SQL_QUERY .= "comm_mileage_history a where a.int_number is not null and a.str_userid='$str_userid' ";
$SQL_QUERY .= $Str_Query;
...
$SQL_QUERY .= $Tname;
$SQL_QUERY .= "comm_mileage_history a ";
...
<head>
	...
	<script language="javascript" src="js/memb_user_stamp_list.js"></script>
</head>
				...
				<table width=100%>
					<tr>
						<td style="padding:10px">
							...
							<form id="frm" name="frm" target="_self" method="POST" action="memb_user_stamp_list.php">
										...
										<? for ($i = 0; $i <= $displayrow - 1; $i++) { ?>
											<tr height=30 align="center">
												...
												<td style="text-align:left;">
													<?php
													if (mysql_result($result, $i, 'str_income') == 'Y') {
												...
												<td><?= number_format(mysql_result($result, $i, int_value)) ?>원</td>
												<td>
