...
<?
	...
	$SQL_QUERY.=$Tname;
	$SQL_QUERY.="comm_member_stamp a where a.int_number is not null and a.str_userid='$str_userid' ";
	$SQL_QUERY.=$Str_Query;
					...
					<td style="padding:10px">
						...
						<table class=tb>
							...
							<tr>
								<td>아이디</td>
								<td colspan="3">
									<input type="text" NAME="Txt_code" value="<?=$Txt_code?>" style="width:300px;">
								</td>
							</tr>
							<tr>
								<td>등록일</td>
