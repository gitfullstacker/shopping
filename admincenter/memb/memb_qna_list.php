											...
											<tr height=30 align="center">
												...
												<td height="70" align="left" valign="middle">
													<table>
														<tr>
															...
															<td>
																<?php
																// 1: 교환, 2: 환불, 3: 취소(출하전 취소), 4: 배송, 5: 불량/AS, 6: 주문/결제, 7: 상품/재입고, 8: 적립금, 9: 회원 관련, 10: 기타 문의, 11: 신고
																$int_type_str = '';
												...
												<td>
													<span id="navig" name="navig" m_id="admin" m_no="1">
														<font color=0074BA><b><?= mysql_result($result, $i, str_userid) ?>(<?= mysql_result($result, $i, str_name) ?>)</b></font>
													</span>
												</td>
