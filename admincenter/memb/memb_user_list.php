...
//	$SQL_QUERY = "select a.*,(select ifnull(sum(c.int_stamp),0) from ".$Tname."comm_member_stamp c where a.str_userid=c.str_userid) as int_stamp,
...
//	$SQL_QUERY.="limit $f_limit,$l_limit";
	...
	$SQL_QUERY = "select a.*,(select ifnull(sum(c.int_stamp),0) from ablanc_comm_member_stamp c where a.str_userid=c.str_userid) as int_stamp from ".$Tname."comm_member a where a.int_gubun<=2 ";
	$SQL_QUERY.=$Str_Query;
	$SQL_QUERY.="order by a.dtm_indate desc ";
	$SQL_QUERY.="limit $f_limit,$l_limit";
