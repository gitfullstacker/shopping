	function RowClick(str_no) {
		...
		document.frm.action = "memb_user_edit.php"
		document.frm.submit();
	}
	function AddNew() {
	...
	function fnc_search() {
		...
		document.frm.action = "memb_user_list.php";
		document.frm.submit();
	}
		...
		if (frm.txtRows.value==0) {
			...
			if (rowCnt >1){
	  		...
	  		if (!count) {
				...
				document.frm.action = "memb_user_edit_proc.php";
	...
	function fnc_Excel() {
		...
		document.frm.action = "memb_user_excel.php";
		document.frm.submit();
	}
