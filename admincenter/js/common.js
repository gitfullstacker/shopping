...
function popupLayer(s,w,h)
{
	...
	with (ifrm.style){
		width = w - 0+"px";
		height = h - pixelBorder * 2 - titleHeight + 2+"px";
...
function npopupLayer(s,w,h)
{
	...
	*/
	...
	var pleft = (posX + document.documentElement.scrollLeft)+"px";
	/*** 내용프레임 레이어 ***/
	var obj = document.createElement("div");
	with (obj.style){
		position = "absolute";
...
//		zIndex = "99999" ;
	...
	with (bottom.style){
		position = "absolute";
		width = w - pixelBorder * 0+"px";
		height = titleHeight+"px";
		left = 0+"px";
		top = h - titleHeight - pixelBorder * 0+"px";
		padding = "1px 0 0 0";
		textAlign = "right";
		//backgroundColor = "#000000";
		color = "#ffffff";
