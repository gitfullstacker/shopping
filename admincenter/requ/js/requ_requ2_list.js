	function RowClick(str_no) {
		popupLayer("requ_requ2_edit.php?RetrieveFlag=UPDATE&str_no="+str_no,800,500);
	}
	function AddNew() {
		document.frm.RetrieveFlag.value="INSERT";
		document.frm.action = "requ_requ2_edit.php";
		document.frm.submit();
	}
	function fnc_search() {
		document.frm.page.value=1;
		document.frm.action = "requ_requ2_list.php";
		document.frm.submit();
	}
