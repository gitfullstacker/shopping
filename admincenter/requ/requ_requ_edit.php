...
<script language="javascript" src="js/requ_requ_edit.js"></script>
</head>
<body class=scroll>
			...
			<table width=100%>
				<tr>
					<td style="padding:10px">
						...
						<form id="frm" name="frm" target="_self" method="POST" action="requ_requ_edit.php" enctype="multipart/form-data">
