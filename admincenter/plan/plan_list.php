...
$SQL_QUERY .= $Tname;
$SQL_QUERY .= "comm_plan a where a.int_number is not null ";
$SQL_QUERY .= $Str_Query;
...
<head>
    ...
    <script language="javascript" src="js/plan_list.js"></script>
</head>
                ...
                <table width=100%>
                    <tr>
                        <td style="padding:10px">
                            ...
                            <form id="frm" name="frm" target="_self" method="POST" action="plan_list.php">
