...
<head>
	...
	<script language="javascript" src="js/plan_select.js"></script>
</head>
				...
				<table width=100%>
					<tr>
						<td style="padding:10px">
							...
							<form id="frm" name="frm" target="_self" method="POST" action="plan_select.php" enctype="multipart/form-data">
								...
								<div class=button>
									...
									<a href='plan_list.php?int_gubun=<?= $int_gubun ?>'><img src='/admincenter/img/btn_list.gif'></a>
								</div>
