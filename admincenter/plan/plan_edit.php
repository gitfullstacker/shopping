...
<head>
	...
	<script language="javascript" src="js/plan_edit.js"></script>
</head>
				...
				<table width=100%>
					<tr>
						<td style="padding:10px">
							...
							<form id="frm" name="frm" target="_self" method="POST" action="plan_edit.php" enctype="multipart/form-data">
									...
									<tr>
										...
										<td colspan=3>
											<table class=tb>
												...
												<tr>
													<td align="center" valign="middle" height="150"><? if ($RetrieveFlag == "UPDATE") { ?><? if (!($arr_Data['STR_IMAGE'] == "")) { ?><img src="/admincenter/files/plan/<?= $arr_Data['STR_IMAGE'] ?>" border="0"><? } else { ?>&nbsp;<? } ?><? } else { ?>&nbsp;<? } ?></td>
												</tr>
											</table>
										</td>
									</tr>
								...
								<div class=button>
									...
									<a href='plan_list.php'><img src='/admincenter/img/btn_list.gif'></a>
								</div>
							</form>
