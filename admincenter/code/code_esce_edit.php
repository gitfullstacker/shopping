...
<script language="javascript" src="js/code_esce_edit.js"></script>
</head>
<body class=scroll>
			...
			<table width=100%>
				<tr>
					<td style="padding:10px">
						...
						<form id="frm" name="frm" target="_self" method="POST" action="code_esce_edit.php">
						...
						<a href='code_esce_list.php?str_idxcode=<?=$str_idxcode?>'><img src='/admincenter/img/btn_list.gif'></a>
						</div>
