							...
							<tr>
								<td valign=top>
									...
									<div style="padding-bottom:1px"><span>
										...
										<iframe src="/admincenter/code/code_vi_road.php?str_menutype=<?=$str_menutype?>" frameborder="0" width="98%" height="99%" marginwidth="0" name="_TreeView" marginheight="0" scrolling="yes"></iframe>
								...
								<td valign=top width=100% style="padding-left:10px"> 
									...
									<script language="javascript">
										fuc_set('/admincenter/code/code_input_road.php?str_menutype=<?=$str_menutype?>','_Incode');
										table_design_load();
									</script>
