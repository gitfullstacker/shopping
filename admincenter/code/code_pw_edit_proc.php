	...
	switch($RetrieveFlag){
     	case "INSERT" :
			...
			<script language="javascript">
				window.location.href="code_pw_edit.php?RetrieveFlag=UPDATE&page=1&str_no=<?=$lastnumber?>&str_idxcode=<?=$str_idxcode?>";
			</script>
			<?
			exit;
			break;
		...
		case "UPDATE" :
			...
			?>
			<script language="javascript">
				window.location.href="code_pw_edit.php?RetrieveFlag=UPDATE&page=<?=$page?>&str_idxcode=<?=$str_idxcode?>&str_no=<?=$str_no?>";
			</script>
			<?
			exit;
			break;
		...
		case "ADELETE" :
			...
			?>
			<script language="javascript">
				window.location.href="code_pw_list.php?str_idxcode=<?=$str_idxcode?>";
			</script>
			<?
			exit;
			break;
