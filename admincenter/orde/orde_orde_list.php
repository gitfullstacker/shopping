						...
						<table width=100% cellpadding=0 cellspacing=0 border=0>
							...
							<tr>
								<td colspan=12 style="padding-top:0px;padding-bottom:5px;">
										<table class=tb>
											<col class=cellC style="width:10%"><col class=cellL style="width:40%">
											<col class=cellC style="width:10%"><col class=cellL style="width:40%">
											<tr>
												<td>사용자메모</td>
												<td style="height:20px;" valign="top"><font class=def><?=str_replace(chr(13),"<br>",Fnc_Om_Conv_Default(mysql_result($result,$i,str_memo),""))?></td>
												<td>관리자메모</td>
