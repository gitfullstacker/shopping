...
if ($RetrieveFlag == "UPDATE") {
	...
	$SQL_QUERY =	" SELECT
						A.*,B.STR_NAME,B.STR_HP,C.STR_GOODNAME,C.INT_TYPE,B.STR_EMAIL,D.STR_USERCODE
					FROM "
							...
							<form id="frm" name="frm" target="_self" method="POST" action="orde_orde_edit.php" enctype="multipart/form-data">
								...
								<table class=tb>
									...
									<tr>
										<td>핸드폰</td>
										<td colspan="3">
											<font class=def><?= $arr_Data['STR_HP'] ?>
										</td>
									</tr>
									<tr>
										<td>주소</td>
										<td colspan="3">
											<font class=def><?= $arr_Data['STR_POST'] ?>] <?= $arr_Data['STR_ADDR1'] . " " . $arr_Data['STR_ADDR2'] ?>
										</td>
									</tr>
									<tr>
										<td>맡길 곳</td>
									...
									<tr>
										...
										<td colspan="3" style="height:50px;" valign="top">
											<font class=def><?= str_replace(chr(13), "<br>", Fnc_Om_Conv_Default($arr_Data['STR_MEMO'], "")) ?>
										</td>
									</tr>
									<tr>
										<td>상품코드</td>
										<td colspan="3">
											<font class=def><?= $arr_Data['STR_USERCODE'] ?>
										</td>
									</tr>
									<tr>
										<td>상품</td>
										<td colspan="3">
											<font class=def><?= $arr_Data['STR_GOODNAME'] ?>
										</td>
									</tr>
									<?php
								...
								<table class=tb>
									...
									<tr>
										<td>주소</td>
										<td colspan="3">
											<font class=def><?= $arr_Data['STR_RPOST'] ?>] <?= $arr_Data['STR_RADDR1'] . " " . $arr_Data['STR_RADDR2'] ?>
										</td>
									</tr>
									<tr>
										<td>반납 방법</td>
									...
									<tr>
										<td>메모</td>
										<td colspan="3" style="height:50px;" valign="top">
											<font class=def><?= str_replace(chr(13), "<br>", Fnc_Om_Conv_Default($arr_Data['STR_RMEMO'], "")) ?>
										</td>
									</tr>
								</table>
								<br>
