		...
		<td>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" class="td150" style="table-layout:fixed">
				...
				<tr height=30 align="center">
					...
					<td align="center">
						<?=mysql_result($arr_Notice_Data,$int_I,bd_item1)?>
					</td>
					<td align="center">
						<?=mysql_result($arr_Notice_Data,$int_I,bd_item2)?>~<?=mysql_result($arr_Notice_Data,$int_I,bd_item3)?>
					</td>
					<td align="center">
						<a href="javascript:popupLayer('/admincenter/recru/recru_recru_list.php?int_pnumber=<?=mysql_result($arr_Notice_Data,$int_I,bd_seq)?>',800,500);"><img src="/admincenter/img/btn_viewbbs.gif" align="absmiddle"></a>
					</td>
				...
				<tr height=30 align="center">
					...
					<td align="center">
						<?=mysql_result($arr_Get_Data,$int_I,bd_item1)?>
					</td>
					<td align="center">
						<?=mysql_result($arr_Get_Data,$int_I,bd_item2)?>~<?=mysql_result($arr_Get_Data,$int_I,bd_item3)?>
					</td>
					<td align="center">
						<a href="javascript:popupLayer('/admincenter/recru/recru_recru_list.php?int_pnumber=<?=mysql_result($arr_Get_Data,$int_I,bd_seq)?>',800,500);"><img src="/admincenter/img/btn_viewbbs.gif" align="absmiddle"></a>
					</td>
					<td align="center">
						<?
