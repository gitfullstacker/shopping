...
<!--
	...
	function fnc_Eb_Send(pr_Form, pr_Mtx)
	{
		...
		if(!obj_Blank(obj_Form.txt_item2.value))
			return obj_Alert(obj_Form.txt_item2, null, "기간을 입력하세요.");			

		if(!obj_Blank(obj_Form.txt_item3.value))
			return obj_Alert(obj_Form.txt_item3, null, "기간을 입력하세요.");						
	...
	<tr>
		<td>
			...
			<table border="0" cellpadding="1" cellspacing="0" width="100%">
				...
				<tr height="25">
					<td align="right" bgcolor="#f2f2f2" class="td130">
						<font color="#4b4b4b">채용구분</font>
					</td>
					<td style="word-break:break-all">
						<input type="text" class="input_basic" name="txt_item1" size="20" maxlength="20" value="<?=$arr_Get_Data[0][19]?>">
					</td>
				</tr>
				<SCRIPT LANGUAGE="JavaScript">
				<!--
				...
				<tr height="25">
					<td align="right" bgcolor="#f2f2f2" class="td130">
						<font color="#4b4b4b">기간</font>
					</td>
					<td style="word-break:break-all">
						<input type="text" class="input_basic" name="txt_item2" id="txt_item2" size="20" maxlength="10" value="<?=$arr_Get_Data[0][20]?>" readonly>
						<img src="/pub/img/icons/calendar_add.gif" align="absmiddle" style="cursor:pointer" onclick="displayCalendar(document.frm_Send.txt_item2 ,'yyyy-mm-dd',document.frm_Send.txt_item2)">
						<img src="/pub/img/icons/calendar_delete.gif" align="absmiddle" style="cursor:pointer" onclick="document.frm_Send.txt_item2.value=''";>
						~
						<input type="text" class="input_basic" name="txt_item3" id="txt_item3" size="20" maxlength="10" value="<?=$arr_Get_Data[0][21]?>" readonly>
						<img src="/pub/img/icons/calendar_add.gif" align="absmiddle" style="cursor:pointer" onclick="displayCalendar(document.frm_Send.txt_item3 ,'yyyy-mm-dd',document.frm_Send.txt_item3)">
						<img src="/pub/img/icons/calendar_delete.gif" align="absmiddle" style="cursor:pointer" onclick="document.frm_Send.txt_item3.value=''";>
					</td>
				</tr>
				<SCRIPT LANGUAGE="JavaScript">
				<!--
