			...
			<table border="0" cellpadding="3" cellspacing="0" width="100%">
				...
				<tr height="25">
					<td align="right" bgcolor="#f2f2f2" class="td130">
						<font color="#4b4b4b">분 류</font>
					</td>
					<td style="word-break:break-all">
						<?
						switch ($int_Ini_Board_Seq) {
							case  "13" : $str_idxcode = "11"; break;
							case  "14" : $str_idxcode = "12"; break;
							case  "15" : $str_idxcode = "13"; break;
							case  "16" : $str_idxcode = "14"; break;
							case  "17" : $str_idxcode = "15"; break;
							case  "18" : $str_idxcode = "16"; break;
							case  "19" : $str_idxcode = "17"; break;
							case  "20" : $str_idxcode = "18"; break;
							case  "21" : $str_idxcode = "19"; break;
							case  "22" : $str_idxcode = "20"; break;
							case  "23" : $str_idxcode = "21"; break;
							case  "24" : $str_idxcode = "22"; break;
							case  "25" : $str_idxcode = "23"; break;
							case  "26" : $str_idxcode = "24"; break;
							case  "27" : $str_idxcode = "25"; break;
							case  "28" : $str_idxcode = "26"; break;
							case  "29" : $str_idxcode = "27"; break;
							case  "30" : $str_idxcode = "28"; break;
							case  "31" : $str_idxcode = "29"; break;
							case  "32" : $str_idxcode = "30"; break;
							case  "33" : $str_idxcode = "31"; break;
						}
						...
						$SQL_QUERY = "select * from ";
								...
								where
									str_idxcode='".$str_idxcode."' and str_service='Y'
									order by str_idxnum asc" ;

						$arr_code_Data=mysql_query($SQL_QUERY);
						?>
						<select name="txt_item1">
							<option value="00">선택</option>
							<?while($row=mysql_fetch_array($arr_code_Data)){?>
							<option value="<?=$row[STR_IDXWORD]?>" <?if (trim($arr_Get_Data[0][19])==trim($row[STR_IDXWORD])) {?>selected<?}?>><?=$row[STR_IDXWORD]?>
							<?}?>
						</select>
					</td>
				</tr>
