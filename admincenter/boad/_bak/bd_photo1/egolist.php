...
<table border="0" cellpadding="0" cellspacing="0" width="<?=$int_Ini_Table_Width?>">
	<tr>
		<td>
			...
			<table border="0" cellpadding="3" cellspacing="0" width="100%" class="td150" style="table-layout:fixed">
				<form name="frm_List">
				...
				<tr height=30 align="center">
					...
					<td width="8%" align="center"><b><font color="#000000" style="font-size:8pt;">공지</font></b></td>
					<td width="50%" style="word-break:break-all" nowrap align="left">
						<?
							// &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
			...
			<table border="0" cellpadding="3" cellspacing="0" width="100%" style="table-layout:fixed">
				...
				<?for($int_I = 0 ;$int_I <= $int_Page_Size -1; $int_I++) {?>
					...
					<td>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%" onmouseover="this.style.background='#DDDDDD';" onmouseout="this.style.background='#FFFFFF';" style="table-layout:fixed">
							<tr>
								<td align="center">
							...
							<tr>
								<td align="center">
									...
									?>
									<a href="egoread.php<?=$str_String.$str_Pg?>&seq=<?=mysql_result($arr_Get_Data,$int_I,bd_seq)?>" class="lnk0"><img src="egofiledata.php?bd=<?=mysql_result($arr_Get_Data,$int_I,conf_seq)?>&iseq=<?=mysql_result($arr_Get_Data,$int_I,img_seq)?>&ikey=<?=mysql_result($arr_Get_Data,$int_I,img_id_key)?>&tp=1" align="absMiddle" width="<?
																$str_Tmp = mysql_result($arr_Get_Data,$int_I,img_f_width);

																If (mysql_result($arr_Get_Data,$int_I,img_f_width)>$arr_Ini_Board_Info[0][14]) {
																	$str_Tmp = $arr_Ini_Board_Info[0][14];
																}
									...
									?>
									<img src="egofiledata.php?bd=<?=mysql_result($arr_Get_Data,$int_I,conf_seq)?>&iseq=&ikey=" align="absMiddle" border="0">
									<?
										}
										//	= 이미지 출력 종료
										// &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
							...
							<tr>
								<td align="center" style="word-break:break-all;padding:6px;" nowrap>
								<?=mysql_result($arr_Get_Data,$int_I,bd_item1)?><br>
									<?
										// &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
										//	= 비공개글 표시 아이콘 변수에 저장 시작
										$str_Tmp = "";
							...
							<tr><td align="center"><?=str_replace("-", ".",substr(mysql_result($arr_Get_Data,$int_I,bd_reg_date),0,10))?></td></tr>
							<tr><td>&nbsp;<br><br></td></tr>
						</table>
					...
					<?If (($int_M==($int_Page_Size)&&$int_M%$int_Div!=0)||($article_num==1&&$int_M%$int_Div!=0)) {?>
						<?for ($int_J=($int_M%$int_Div);$int_J<$int_Div;$int_J++) {?>
						<td>&nbsp;</td>
						<?}?>
					<?}?>
					<?if ($int_M%$int_Div==0&&$int_M!=($int_Page_Size)&&$article_num!=1) {?>
		        		</tr>
		        		<tr><td colspan="<?=$int_Div?>" height="1" background="<?=$str_Board_Icon_Img?>line_dot.gif"></td></tr>
		        		<tr>
		        	<?}?>
				<?
				$article_num--;
