...
<!--
	...
	function fnc_Eb_Send(pr_Form, pr_Mtx)
	{
		...
		if(!obj_Blank(obj_Form.txt_Subject.value))
			return obj_Alert(obj_Form.txt_Subject, null, "프로젝트명을 입력하세요.");

		int_Byte = obj_Byte(obj_Form.txt_Subject, null, 200);
		if(int_Byte>200)
			return obj_Alert(obj_Form.txt_Subject, null, "프로젝트명은 200 Byte이상 입력할 수 없습니다.\n\n현재 : "+int_Byte+" Byte");
	...
	<tr>
		<td>
			...
			<table border="0" cellpadding="3" cellspacing="0" width="100%">
				...
				<tr height="25">
					<td align="right" bgcolor="#f2f2f2" class="td130">
						<font color="#4b4b4b">공사규모 </font>
					</td>
					<td style="word-break:break-all">
						<input type="text" class="input_basic" name="txt_item1" size="40" maxlength="200" value="">
						<SCRIPT LANGUAGE="JavaScript">
						<!--
							document.forms["frm_Send"].elements["txt_item1"].value = unescape('<?=js_escape($arr_Get_Data[0][19])?>');
						//-->
						</SCRIPT>
					</td>
				</tr>
				...
				<tr height="25">
					<td align="right" bgcolor="#f2f2f2" class="td130">
						<font color="#4b4b4b">시공사 </font>
					</td>
					<td style="word-break:break-all">
						<input type="text" class="input_basic" name="txt_item2" size="40" maxlength="200" value="">
						<SCRIPT LANGUAGE="JavaScript">
						<!--
							document.forms["frm_Send"].elements["txt_item2"].value = unescape('<?=js_escape($arr_Get_Data[0][20])?>');
						//-->
						</SCRIPT>
					</td>
				</tr>
				...
				<tr height="25">
					<td align="right" bgcolor="#f2f2f2" class="td130">
						<font color="#4b4b4b">공사기간 </font>
					</td>
					<td style="word-break:break-all">
						<input type="text" class="input_basic" name="txt_item3" size="40" maxlength="200" value="">
						<SCRIPT LANGUAGE="JavaScript">
						<!--
							document.forms["frm_Send"].elements["txt_item3"].value = unescape('<?=js_escape($arr_Get_Data[0][21])?>');
						//-->
						</SCRIPT>
					</td>
				</tr>
				...
				<tr height="25">
					<td align="right" bgcolor="#f2f2f2" class="td130">
						<font color="#4b4b4b">위치 </font>
					</td>
					<td style="word-break:break-all">
						<input type="text" class="input_basic" name="txt_item4" size="40" maxlength="200" value="">
						<SCRIPT LANGUAGE="JavaScript">
						<!--
							document.forms["frm_Send"].elements["txt_item4"].value = unescape('<?=js_escape($arr_Get_Data[0][22])?>');
						//-->
						</SCRIPT>
					</td>
				</tr>
				...
				<tr height="25">
					...
					<td style="font-size:8pt;">
						...
						&nbsp;
						<input type="checkbox" name="txt_item5" value="1" style="border:0px;"<?If ($arr_Get_Data[0][23]=="1") {?> checked<?}?>> 메인
					</td>
				</tr>
