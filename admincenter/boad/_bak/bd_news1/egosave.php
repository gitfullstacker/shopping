...
<?
	...
	$arr_Column_Name = Array(	"BD_ID_KEY",	"BD_IDX",			"BD_ORDER",
								...
								"BD_DEL_YN",	"BD_VIEW_CNT",		"BD_GOOD_CNT",	"BD_BAD_CNT",	"BD_MEMO_CNT",	"BD_ITEM1",	"BD_ITEM2",	"BD_ITEM3",	"BD_ITEM4",	"BD_ITEM5"	);
	...
	$arr_Set_Data[26]	= Fnc_Om_Conv_Default($_REQUEST[txt_item4],"");
	$arr_Set_Data[27]	= Fnc_Om_Conv_Default($_REQUEST[txt_item5],"0");
	...
	If ($bln_Flag) {
		...
		If ($int_Ini_Board_Seq>0 && $int_Bd_Seq==0 && strlen($arr_Set_Data[0])==21) {
			...
			$arr_Tmp =	Array(	"BD_NOTICE_YN",		"BD_W_NAME",
								...
								"BD_FORMAT",		"BD_THUMB_YN",		"BD_OPEN_YN",	"BD_EDIT_DATE",	"BD_ITEM1",	"BD_ITEM2",	"BD_ITEM3",	"BD_ITEM4",	"BD_ITEM5"	);
			...
			$arr_Tmp2[13] = $arr_Set_Data[26];
			$arr_Tmp2[14] = $arr_Set_Data[27];
