...
<table border="0" cellpadding="0" cellspacing="0" width="<?=$int_Ini_Table_Width?>">
	<tr>
		<td>
			...
			<table width=100%>
				<tr>
					<td class=pageInfo>페이지 : <b><?=$int_Total_Page?></b> / <?=$str_Pg?>&nbsp;&nbsp;&nbsp;글수 : <?=$int_Total_Cnt?>&nbsp;&nbsp;&nbsp;<font color="red">[M]</font> : 메인공지</td>
				</tr>
			</table>
			<table border="0" cellpadding="3" cellspacing="0" width="100%" class="td150" style="table-layout:fixed">
				...
				<tr height=30 align="center">
					...
					<td style="word-break:break-all" nowrap align="left">
						...
						<?If (mysql_result($arr_Notice_Data,$int_I,bd_item5)=="1") {?><font color="red">[M]</font><?}?>
					</td>
				...
				<tr height=30 align="center">
					...
					<td style="word-break:break-all" nowrap align="left">
						...
						<?If (mysql_result($arr_Get_Data,$int_I,bd_item5)=="1") {?><font color="red">[M]</font><?}?>
					</td>
					<td align="center">
						<?
				...
				<tr height="32">
					<td align="right">
						...
						<select name="itm" size="1" style="font-size:8pt;">
							<option value="0"<?If ($int_Itm=="0") {?> selected<?}?>>프로젝트명</option>
