...
<table border="0" cellpadding="0" cellspacing="0" width="<?=$int_Ini_Table_Width?>">
	<tr>
		<td>
			...
			<table border="0" cellpadding="1" cellspacing="0" width="100%" class="td150" style="table-layout:fixed">
				<form name="frm_List">
			...
			<table border="0" cellpadding="1" cellspacing="0" width="100%" style="table-layout:fixed">
				...
				<?for($int_I = 0 ;$int_I <= $int_Page_Size -1; $int_I++) {?>
					...
					<?if ($int_M%$int_Div==0&&$int_M!=($int_Page_Size)&&$article_num!=1) {?>
						...
						<tr>
							<tr><td colspan=<?=$int_Div?> class=rndline></td></tr>
						</tr>
		        		<tr>
		        	<?}?>
				<?
				...
				<?}?>
				<tr>
					<tr><td colspan=<?=$int_Div?> class=rndline style="height:1px;"></td></tr>
				</tr>
				<?}?>
				</tr>
			</table>
