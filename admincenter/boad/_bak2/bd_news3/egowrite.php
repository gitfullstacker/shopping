				...
				<tr height="25">
					...
					<td style="word-break:break-all">
						<select class="input_basic" name="txt_item1">
							<option value="">선택
							<option value="기관운영" <?if ($arr_Get_Data[0][19]=="기관운영"){?> selected<?}?>>기관운영
							<option value="활동보조" <?if ($arr_Get_Data[0][19]=="활동보조"){?> selected<?}?>>활동보조
							<option value="고용" <?if ($arr_Get_Data[0][19]=="고용"){?> selected<?}?>>고용
							...
							<option value="기타" <?if ($arr_Get_Data[0][19]=="기타"){?> selected<?}?>>기타
						</select>
					</td>
				</tr>
				<SCRIPT LANGUAGE="JavaScript">
