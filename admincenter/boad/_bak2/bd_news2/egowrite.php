				...
				<tr height="25">
					...
					<td style="word-break:break-all">
						<select class="input_basic" name="txt_item1">
							<option value="">선택
							<option value="구인구직" <?if ($arr_Get_Data[0][19]=="구인구직"){?> selected<?}?>>구인구직
							<option value="개소식" <?if ($arr_Get_Data[0][19]=="개소식"){?> selected<?}?>>개소식
							<option value="행사" <?if ($arr_Get_Data[0][19]=="행사"){?> selected<?}?>>행사
							<option value="홍보" <?if ($arr_Get_Data[0][19]=="홍보"){?> selected<?}?>>홍보
						</select>
					</td>
				</tr>
				<SCRIPT LANGUAGE="JavaScript">
