...
<script type="text/javascript" src="/util/fckeditor.2.6.4/fckeditor.js"></script>
			...
			<table border="0" cellpadding="3" cellspacing="0" width="100%">
				...
				<tr height="25">
					<td align="right" bgcolor="#f2f2f2" class="td130">
						<font color="#4b4b4b">구 분</font>
					</td>
					<td style="word-break:break-all">
						<select class="input_basic" name="txt_item1">
							<option value="">선택
							<option value="투쟁" <?if ($arr_Get_Data[0][19]=="투쟁"){?> selected<?}?>>투쟁
							<option value="동료상담" <?if ($arr_Get_Data[0][19]=="동료상담"){?> selected<?}?>>동료상담
							<option value="활동보조" <?if ($arr_Get_Data[0][19]=="활동보조"){?> selected<?}?>>활동보조
							<option value="고용노동" <?if ($arr_Get_Data[0][19]=="고용노동"){?> selected<?}?>>고용노동
							<option value="보조공학" <?if ($arr_Get_Data[0][19]=="보조공학"){?> selected<?}?>>보조공학
							<option value="주거" <?if ($arr_Get_Data[0][19]=="주거"){?> selected<?}?>>주거
							<option value="윤리" <?if ($arr_Get_Data[0][19]=="윤리"){?> selected<?}?>>윤리
						</select>
					</td>
				</tr>
				<SCRIPT LANGUAGE="JavaScript">
				...
				<tr>
					<td colspan="2">
						<textarea name=mtx_Content style="width:100%;height:200px;"><?=stripslashes($arr_Get_Data[0][13])?></textarea>
						<script type="text/javascript">
							var oFCKeditor = new FCKeditor( 'mtx_Content' ) ;
							oFCKeditor.BasePath	= "/util/fckeditor.2.6.4/";
							oFCKeditor.ToolbarSet	= 'ImageToolbar' ;
