...
<?
	...
	$arr_Set_Data[21]	= 0;
	$arr_Set_Data[22]	= 0;
	$arr_Set_Data[23]	= Fnc_Om_Conv_Default($_REQUEST[txt_item1],"0");
	$arr_Set_Data[24]	= addslashes(Fnc_Om_Conv_Default($_REQUEST[txt_item2],""));
	...
	If ($bln_Flag) {
		...
		If ($int_Ini_Board_Seq>0 && $int_Bd_Seq==0 && strlen($arr_Set_Data[0])==21) {
			...
			$arr_Tmp =	Array(	"BD_NOTICE_YN",		"BD_W_NAME",
								...
								"BD_FORMAT",		"BD_THUMB_YN",		"BD_OPEN_YN",	"BD_EDIT_DATE",	"BD_ITEM1",	"BD_ITEM2"	);
