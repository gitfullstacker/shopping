	...
	<tr>
		<td>
			...
			<table border="0" cellpadding="3" cellspacing="0" width="100%">
				...
				<tr height="25">
					<td align="right" bgcolor="#f2f2f2" class="td130">
						<font color="#4b4b4b">답변여부</font>
					</td>
					<td width="80%">
						<input type="checkbox" name="txt_item1" value="1" style="border:0px;"<?If ($arr_Get_Data[0][19]=="1") {?> checked<?}?>> 답변완료
						&nbsp;
					</td>
				</tr>
				<SCRIPT LANGUAGE="JavaScript">
				...
				<tr>
					<td colspan="2">
						<textarea name="txt_item2" style="width:100%;height:200px;"><?=stripslashes($arr_Get_Data[0][20])?></textarea>
					</td>
				</tr>
				<tr><td height="4" background="<%=str_Board_Icon_Img%>bg_line_top.gif" colspan="2"></td></tr>
			</table>
