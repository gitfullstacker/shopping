...
<script language="javascript" src="js/egolist.js"></script>
<?
// ==================================================
//	= 새글표시를 위한 날짜값 설정 시작
...
$Sql_Query .= " A.BD_ID_KEY IS NOT NULL ";
$Sql_Query .= $Sql_Add_Query;
$Sql_Query .= " ORDER BY BD_BEST DESC ";
				...
				<form name="frm_List">
					...
					?>
						<tr height=30 align="center">
							...
							<td align="center"><b>
									<font color="#000000" style="font-size:8pt;">공지</font>
								</b></td>
							<td align="center">
							...
							<td style="word-break:break-all" nowrap align="left">
								...
								<a href="egoread.php<?= $str_String . $str_Pg ?>&seq=<?= mysql_result($arr_Notice_Data, $int_I, bd_seq) ?>">
									...
									?>
									<b>
										<font color="#000000"><?= $str_Tmp ?></font>
									</b>
								</a>
							</td>
							<td align="center">
...
<? if ($int_Total_Cnt != 0) { ?>
	...
	<? for ($int_I = 0; $int_I <= $int_Page_Size - 1; $int_I++) { ?>
		<tr height=30 align="center">
			...
			<td align="center">
				<button id="best_btn_<?= mysql_result($arr_Get_Data, $int_I, bd_seq) ?>" type="button" style="height: 20px; font-size: smaller;" onClick="Set_Best_Click(<?= mysql_result($arr_Get_Data, $int_I, bd_seq) ?>);"><?= mysql_result($arr_Get_Data, $int_I, bd_best) == 1 ? '해제' : '적용' ?></button>
			</td>
			<td align="center">
				<button id="hide_btn_<?= mysql_result($arr_Get_Data, $int_I, bd_seq) ?>" type="button" style="height: 20px; font-size: smaller;" onClick="Set_Hide_Click(<?= mysql_result($arr_Get_Data, $int_I, bd_seq) ?>);"><?= mysql_result($arr_Get_Data, $int_I, bd_hide) == 1 ? '해제' : '적용' ?></button>
			</td>
		</tr>
		<tr>
		<tr>
