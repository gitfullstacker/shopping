...
; 
			$str_open = $arr_Get_Data[0][17];
			$str_pass = $arr_Get_Data[0][19];
			$bln_Flag = False;
			break;
		default :
			$bln_Flag = False;
	...
	If ($bln_Flag == False) {
		...
		$arr_Get_Data[0][13] = "";
		$arr_Get_Data[0][14] = $str_pass;
		$arr_Get_Data[0][15] = 0;
		$arr_Get_Data[0][16] = $int_Ini_Img_Prev;
		$arr_Get_Data[0][17] = $str_open;
		$arr_Get_Data[0][18] = 0;
		$arr_Get_Data[0][19] = "";
		$arr_Get_Data[0][20] = "";
		$arr_Get_Data[0][21] = "1";
...
<!--
	...
	function fnc_Eb_Send(pr_Form, pr_Mtx)
	{
		...
		if(!obj_Blank(obj_Form.txt_nitem1.value))
			return obj_Alert(obj_Form.txt_nitem1, null, "상품을 선택하세요.");
	...
	function fnc_Image_Save(pr_Form, pr_Lbl, pr_Sel, pr_Type)
	{
		...
		//$("#fil_File_Data").val("");
		//$("#fil_File_Data").replaceWith( $("#fil_File_Data").clone(true) );
		
		//document.getElementById("wrapper").outerHTML = document.getElementById("wrapper").outerHTML;
		//document.getElementById("fil_File_Data").select();
	...
	<tr>
		<td>
			...
			<table border="0" cellpadding="1" cellspacing="0" width="100%">
				...
				<tr height="25">
					<td width="20%" align="right" bgcolor="#f2f2f2" class="td130">
						<font color="#4b4b4b">상품</font>
					</td>
					<td width="80%">
						<input type=text name="txt_nitem1" value="<?=$arr_Get_Data[0][22]?>" size=40 readonly>
						<a href="javascript:popupLayer('egogood.php?obj1=frm_Send&obj2=txt_nitem1&obj3=txt_item1',800,550)"><img src="/admincenter/img/i_search.gif" border=0 align=absmiddle hspace=2></a>
						<img src="/admincenter/img/i_del.gif" border=0 align=absmiddle style="cursor:pointer" onclick="document.frm_Send.txt_nitem1.value='';document.frm_Send.txt_item1.value=''"; >
						<input type=hidden name="txt_item1" value="<?=$arr_Get_Data[0][20]?>">
					</td>
				</tr>
				<SCRIPT LANGUAGE="JavaScript">
				<!--
				...
				<tr height="25">
					<td width="20%" align="right" bgcolor="#f2f2f2" class="td130">
						<font color="#4b4b4b">만족도</font>
					</td>
					<td width="80%">
						<input type="radio" value="1" name="txt_item2" class=null <?If ($arr_Get_Data[0][21]=="1") {?> checked<?}?>> <img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" />
						<input type="radio" value="2" name="txt_item2" class=null <?If ($arr_Get_Data[0][21]=="2") {?> checked<?}?>> <img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" />
						<input type="radio" value="3" name="txt_item2" class=null <?If ($arr_Get_Data[0][21]=="3") {?> checked<?}?>> <img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" />
						<input type="radio" value="4" name="txt_item2" class=null <?If ($arr_Get_Data[0][21]=="4") {?> checked<?}?>> <img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" />
						<input type="radio" value="5" name="txt_item2" class=null <?If ($arr_Get_Data[0][21]=="5") {?> checked<?}?>> <img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" />
					</td>
				</tr>
				<SCRIPT LANGUAGE="JavaScript">
				<!--
			...
			<input type="hidden" name="txt_File_Desc" value="">
				<tr height="25">
					<td width="20%" align="right" bgcolor="#f2f2f2" class="td130">
						<font color="#4b4b4b">파일선택</font>
					</td>
					<td width="80%" id="lbl_File_Re_Write">
						<input type="file" class="input_basic" name="fil_File_Data" id="fil_File_Data" size="52">
					</td>
				</tr>
				...
				<tr>
					<td align="right" bgcolor="#f2f2f2" class="td130">
						<!--<font color="#4b4b4b">내 용</font>//-->
					</td>
					<td>
						<textarea class="input_basic" name="mtx_File_Content" wrap="soft" cols="67" rows="2" style="display:none;"></textarea>
