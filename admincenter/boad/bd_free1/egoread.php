		...
		<td>
			...
			<table border="0" cellpadding="1" cellspacing="0" width="100%">
				...
				<tr height="25">
					...
					<td bgcolor="white">
						<font color="#000000"><?= $arr_Get_Data[0][19] ?></font>
					</td>
				</tr>
				<SCRIPT LANGUAGE="JavaScript">
					document.write(fnc_Line_Divide());
				...
				<tr height="25">
					...
					<td bgcolor="white">
						<? if ($arr_Get_Data[0][20] == "1") { ?><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><? } ?>
						<? if ($arr_Get_Data[0][20] == "2") { ?><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><? } ?>
						<? if ($arr_Get_Data[0][20] == "3") { ?><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><? } ?>
						<? if ($arr_Get_Data[0][20] == "4") { ?><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star0.gif" alt="" /><? } ?>
						<? if ($arr_Get_Data[0][20] == "5") { ?><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><img src="/images/board/icn_star1.gif" alt="" /><? } ?>
					</td>
				</tr>
				<SCRIPT LANGUAGE="JavaScript">
					document.write(fnc_Line_Divide());
				...
				<tr height="25">
					...
					<td bgcolor="white">
						<font color="#000000">
							<?php
							switch ($arr_Get_Data[0]['INT_USTAR']) {
								case '3':
									echo "만족";
									break;
								case '2':
				...
				<tr height="25">
					...
					<td bgcolor="white">
						<font color="#000000">
							<?php
							switch ($arr_Get_Data[0]['INT_PSTAR']) {
								case '3':
									echo "만족";
									break;
								case '2':
				...
				<tr height="25">
					...
					<td bgcolor="white">
						<font color="#000000">
							<?php
							switch ($arr_Get_Data[0]['INT_DSTAR']) {
								case '3':
									echo "만족";
									break;
								case '2':
				...
				<tr>
					<td height="4" background="<?= $str_Board_Icon_Img ?>bg_line_top.gif" colspan="2"></td>
				</tr>
				<? if ($arr_Get_Data[0][9] != "") { ?>
					<tr>
								...
								<tr>
									<td align="center" colspan="2">
										...
										<table border="0" cellpadding="0" cellspacing="2">
											...
											?>
												<tr>
													<td><img src="<?= $str_Board_Icon_Img ?>ic_pen.gif" align="absMiddle">
														<font color="#000000"><b><?= Fnc_Conv_View(mysql_result($arr_File_Data, $int_I, F_TITLE), 0) ?></b></font>
													</td>
												</tr>
											<?
											}
											...
											?>
												<tr>
													<td>
														<font color="#000000"><?= Fnc_Conv_View(mysql_result($arr_File_Data, $int_I, F_CONT), 0) ?></font>
													</td>
												</tr>
											<?
											}
				...
				?>
					<tr>
						...
						<td>
							...
							?>
										<a href="egofiledown.php?bd=<?= $int_Conf_Seq ?>&ftype=<?= mysql_result($arr_File_Data, $int_I, TYPE) ?>&fseq=<?= mysql_result($arr_File_Data, $int_I, SEQ) ?>&key=<?= mysql_result($arr_File_Data, $int_I, SKEY) ?>" class="lnk0" target="_top"><img src="<?= $arr_Ini_Board_Info[0][6] ?>ext/<?= fnc_File_Exe_Icon(mysql_result($arr_File_Data, $int_I, F_TYPE)) ?>" align="absMiddle">&nbsp;<font color="black"><?= mysql_result($arr_File_Data, $int_I, F_NAME) ?></font>
											<font color="#00a99d">[<?= fnc_File_Size(mysql_result($arr_File_Data, $int_I, F_SIZE)) ?>]</font>
										</a>
										<br>
									<?
									}
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td height="4" background="<?= $str_Board_Icon_Img ?>bg_line_btm.gif"></td>
				</tr>
				<tr>
					<td height="18" background="<?= $str_Board_Icon_Img ?>bg_btm_table.gif">&nbsp;</td>
				</tr>
			</table>
									...
									<tr>
										<td width="100%">
											<table border="0" cellpadding="3" cellspacing="0" width="100%">
												...
												<tr>
													<td height="1" colspan="2" background="<?= $str_Board_Icon_Img ?>bg_line.gif"></td>
												</tr>
												<tr height="32">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td height="3" background="<?= $str_Board_Icon_Img ?>bg_line.gif"></td>
				</tr>
			</table>
			<!-- ///@@@ 이전글/다음글 출력 시작 -->
			<? if ($arr_Prev_Data_Cnt || $arr_Next_Data_Cnt) { ?>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td height="1" background="<?= $str_Board_Icon_Img ?>bg_line.gif"></td>
					</tr>
				</table>
			<? } ?>
			<!-- 이전글/다음글 출력 종료 @@@/// -->
