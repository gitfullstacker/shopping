	function RowClick(str_no) {
		...
		document.frm.action = "sche_sche_edit.php"
		document.frm.submit();
	}
	function AddNew() {
	...
	function fnc_search() {
		...
		document.frm.action = "sche_sche_list.php";
		document.frm.submit();
	}
	...
	function fnc_service(chkObj,str_no) {
	 	param = "RetrieveFlag=SERVICE&str_no="+str_no+"&str_service="+((chkObj.checked) ? "Y" : "N")
	 	param="sche_sche_edit_proc.php?"+param
	 	fuc_ajax(param);
	 	alert("수정되었습니다.");
	}