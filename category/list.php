...
<script language="javascript" src="js/list.js"></script>
		...
		<div id="container">
			...
			<div class="sub_container">
				...
				<?
				$SQL_QUERY =	" select * from ".$Tname."comm_banner as a where a.str_bcode='".$Txt_bcode."' and a.int_gubun='2' ";
				...
				<div class="contents_w">
					...
					<p class="list_option mt30"><a href="javascript:fnc_gbn('0');"><?If ($Txt_rent=="0") {?><b>전체 가방</b><?}else{?>전체 가방<?}?></a> <i class="icn icn_bar"></i> <a href="javascript:fnc_gbn('1');"><?If ($Txt_rent=="1") {?><b>GET 가능한 가방</b><?}else{?>GET 가능한 가방<?}?></a></p>
						...
						<div id="layout" class="hover-grid">
							...
							<div class="item hover-grid-item">
								<div style="position:relative;">
									...
									<dl>
										<dt><a href="detail.php<?=$str_String?>&str_no=<?=mysql_result($result,$i,str_goodcode)?>"><?=mysql_result($result,$i,str_code)?></a></dt>
									...
									<div class="caption" style="display: none;">
										...
										<?If ($arr_Auth[0]=="") {?>
											<p class="on_btn mt15"><a href="detail.php<?=$str_String?>&str_no=<?=mysql_result($result,$i,str_goodcode)?>" class="btn btn_get">GET</a></p>
										<?}else{?>
											<?if ($sBuy > 0) {//구매가 있을때?>
												<?if ($sRent!=0) {//품절이 아닐때?>
													...
													<?}else{?>
														<p class="on_btn mt30"><a href="detail.php<?=$str_String?>&str_no=<?=mysql_result($result,$i,str_goodcode)?>" class="btn btn_get">CHANGE</a></p>
													<?}?>
												<?}else{?>
											...
											<?}else{//구매가 없을때?>
												<?if ($sRent!=0) {//품절이 아닐때?>
													<p class="on_btn mt30"><a href="detail.php<?=$str_String?>&str_no=<?=mysql_result($result,$i,str_goodcode)?>" class="btn btn_get">GET</a></p>		
												<?}?>
											<?}?>
										<?}?>
									</div>
