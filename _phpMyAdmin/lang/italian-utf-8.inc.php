...
$strAccessDeniedCreateConfig = 'La ragione di questo 챔 che probabilmente non hai creato alcun file di configurazione. Potresti voler usare %1$ssetup script%2$s per crearne uno.';
...
$strAllowInterrupt = 'Permette di interrompere il processo di importazione nel caso lo script rilevi che 챔 troppo vicino al tempo limite. Questo potrebbe essere un buon modo di importare grandi file, tuttavia potrebbe interrompere la transazione.';
...
$strAnIndex = 'Un indice 챔 stato aggiunto in %s';
$strAnyHost = 'Qualsiasi host';
$strAny = 'Qualsiasi';
$strAnyUser = 'Qualsiasi utente';
$strApproximateCount = 'Pu챵 essere approssimato. Vedere FAQ 3.11';
$strAPrimaryKey = 'Una chiave primaria 챔 stata aggiunta in %s';
$strArabic = 'Arabo';
$strArmenian = 'Armeno';
...
$strBookmarkDeleted = 'Il bookmark 챔 stato cancellato.';
...
$strBrowse = 'Mostra';
$strBufferPoolActivity = 'Attivit횪 del Buffer Pool';
...
$strBzError = 'phpMyAdmin non 챔 capace di comprimere il dump a causa dell\'estensione Bz2 errata in questa versione di PHP. Vi raccomandiamo vivamente di settare il parametro <code>$cfg[\'BZipDump\']</code> nel vostro file di configurazione di phpMyAdmin a <code>FALSE</code>. Se volete utilizzare le capacit횪 di compressione Bz2, dovreste aggiornare il PHP all\'ultima versione. Date un\'occhiata al bug report %s per uteriori dettagli.';
...
$strCompressionWillBeDetected = 'Il tipo di compressione del file importato sar횪 automaticamente rilevato da: %s';
$strConfigDefaultFileError = 'Non posso leggere la configurazione da: "%1$s"';
$strConfigFileError = 'phpMyAdmin non riesce a leggere il file di configurazione!<br />Questo pu챵 accadere se il php trova un parse error in esso oppure il php non trova il file.<br />Richiamate il file di configurazione direttamente utilizzando il link sotto e leggete il/i messaggio/i di errore del php che ricevete. Nella maggior parte dei casi ci sono un apostrofo o una virgoletta mancanti.<br />Se ricevete una pagina bianca, allora 챔 tutto a posto.';
...
$strCopy = 'Copia';
$strCopyDatabaseOK = 'Il Database %s 챔 stato copiato in %s';
$strCopyTable = 'Copia la tabella nel (database<b>.</b>tabella):';
$strCopyTableOK = 'La tabella %s 챔 stata copiata su %s.';
$strCopyTableSameNames = 'Impossibile copiare la tabella su se stessa!';
$strCouldNotKill = 'phpMyAdmin non 챔 in grado di terminare il thread %s. Probabilmente 챔 gi횪 stato terminato.';
$strCreate = 'Crea';
...
$strDatabaseEmpty = 'Il nome del DataBase 챔 vuoto!';
$strDatabaseExportOptions = 'Opzioni di esportazione del database';
$strDatabaseHasBeenDropped = 'Il Database %s 챔 stato eliminato.';
...
$strDefaultEngine = '%s 챔 il motore di memorizzazione predefinito su questo server MySQL.';
...
$strDeleteAndFlushDescr = 'Questa 챔 la vita pi첫 giusta, ma il caricamento dei privilegi pu챵 durare qualche secondo.';
$strDeleted = 'La riga 챔 stata cancellata';
...
$strDelOld = 'La Pagina corrente contiene Riferimenti a Tabelle che non esistono pi첫. Volete cancellare questi Riferimenti?';
...
$strDumpSaved = 'Il dump 챔 stato salvato sul file %s.';
...
$strEnd = 'Fine';
$strEndRaw = 'FINE RAW';
$strEngineAvailable = '%s 챔 disponibile su questo server MySQL.';
$strEngineDisabled = '%s 챔 stato disabilitato su questo server MySQL.';
$strEngines = 'Motori';
...
$strErrorRelationExists = 'Errore: relazione gi횪 esistente.';
...
$strField = 'Campo';
$strFieldHasBeenDropped = 'Il campo %s 챔 stato eliminato';
...
$strFileAlreadyExists = 'Il file %s esiste gi횪 sul server: prego, cambiare nome del file o selezionare l\'opzione "sovrascrivi".';
$strFileCouldNotBeRead = 'Il file non pu챵 essere letto';
$strFileNameTemplateDescriptionDatabase = 'nome database';
$strFileNameTemplateDescription = 'Questo valore 챔 interpretato usando %1$sstrftime%2$s, in questo modo puoi usare stringhe di formattazione per le date/tempi. Verranno anche aggiunte le seguenti trasformazioni: %3$s. Il testo rimanente rester횪 invariato.';
...
$strHandler = 'Handler';
$strHasBeenAltered = '챔 stato modificato.';
$strHasBeenCreated = '챔 stato creato.';
...
$strHostEmpty = 'Il nome di host 챔 vuoto!';
$strHost = 'Host';
...
$strIndexHasBeenDropped = 'L\'indice %s 챔 stato eliminato';
$strIndex = 'Indice';
...
$strInsecureMySQL = 'Il file di configurazione in uso contiene impostazioni (root con nessuna password) che corrispondono ai privilegi dell\'account MySQL predefinito. Un server MySQL funzionante con queste impostazioni 챔 aperto a intrusioni, e si dovrebbe realmente riparare a questa falla nella sicurezza.';
$strInsertAsNewRow = 'Inserisci come nuova riga';
$strInsertedRowId = 'Inserito id riga:';
$strInsertedRows = 'Righe inserite:';
$strInsert = 'Inserisci';
$strInternalNotNecessary = '* Non 챔 necessaria una relazione interna quando gi횪 esiste in InnoDB.';
...
$strInvalidRowNumber = '%d non 챔 un numero valido di righe.';
...
$strJustDeleteDescr = 'Gli utenti &quot;cancellati&quot; saranno ancora in grado di accedere al servercome al solito finch챕 i privilegi non verraanno ricaricati.';

$strKeepPass = 'Non cambiare la password';
$strKeyCache = 'Key cache';
$strKeyname = 'Nome chiave';
$strKill = 'Rimuovi';
$strKnownExternalBug = 'La %s funzionalit횪 챔 affetta da un bug noto, vedi %s';
$strKorean = 'Coreano';
...
$strMbExtensionMissing = 'L\'estensione PHP mbstring non 챔 stata trovata e sembra che si stia utilizzando un set di caratteri multibyte. Senza l\'estensione mbstring, phpMyAdmin non 챔 in grado di dividere correttamente le stringhe di caratteri e questo pu챵 portare a risultati inaspettati.';
$strMbOverloadWarning = 'Avete abilitato mbstring.func_overload nella configurazione del PHP. Questa opzione 챔 incompatibile con phpMyAdmin e potrebbe causare la corruzione di alcuni dati!';
...
$strMIME_nodescription = 'Nessuna descrizione 챔 disponibile per questa trasformazione.<br />Prego, chiedere all\'autore cosa %s faccia.';
...
$strMIME_transformation_options_note = 'Prego, immettere i valori per le opzioni di trasformazioneutilizzando questo formato: \'a\', 100, b,\'c\'...<br />Se c\'챔 la necessit횪 di immettere un backslash ("\") o un apostrofo ("\'") tra questi valori, essi vanno backslashati (per es. \'\\\\xyz\' or \'a\\\'b\').';
...
$strModify = 'Modifica';
$strMoveMenu = 'Muovi men첫';
$strMoveTableOK = 'La tabella %s 챔 stata spostata in %s.';
...
$strMyISAMDataPointerSizeDesc = 'Dimensione del puntatore predefinito in Bytes, che deve essere usata da CREATE TABLE per le tabelle MyISAM quando non 챔 stata specificata l\'opzione MAX_ROWS.';
$strMyISAMDataPointerSize = 'Domensione del puntatore dati';
$strMyISAMMaxExtraSortFileSizeDesc = 'Se il file temporaneo 챔 usato per la creazione veloce di un indice MyISAM, occuperebbe pi첫 spazio dell\'utilizzo del metodo key cache con la quantit횪 ivi specificata: perci챵 si deve prediligere il metodo key cache.';
$strMyISAMMaxExtraSortFileSize = 'Dimensione massima per i file temporanei nella creazione di un indice';
$strMyISAMMaxSortFileSizeDesc = 'La dimensione massima dei file temporanei MySQL pu챵 essere utilizzata nella rigenerazione di un indice MyISAM (durante un REPAIR TABLE, ALTER TABLE, o LOAD DATA INFILE).';
$strMyISAMMaxSortFileSize = 'Dimensione massima dei file temporanei di ordinamento';
$strMyISAMRecoverOptionsDesc = 'La modalit횪 di irppristino automatico di tabelle MyISAM corrotte, come impostato tramite l\'opzione di lan cio del server --myisam-recover.';
$strMyISAMRecoverOptions = 'Modalit횪 di ripristino automatico';
$strMyISAMRepairThreadsDesc = 'Se questo valore 챔 maggiore di 1, gli indici della tabella MyISAM vengono creati in parallelo (ogni indice nel suo thread) durante il processo di ordinamento Repair by.';
...
$strName = 'Nome';
$strNext = 'Prossimo';
$strNoActivity = 'Nessuna attivit횪 da %s secondi o pi첫, si prega di autenticarsi nuovamente';
$strNoDatabases = 'Nessun database';
$strNoDatabasesSelected = 'Nessun database selezionato.';
$strNoDataReceived = 'Non sono stati ricevuti dati da importare. O non 챔 stato indicato alcun nome file, oppure 챔 stato superata la dimensione massima consentita per il file, impostata nella configurazione di PHP. Vedi FAQ 1.16.';
$strNoDescription = 'nessuna Description';
$strNoDetailsForEngine = 'Non 챔 disponibile nessuna informazione dettagliata sullo stato di questo motore di memorizzazione.';
...
$strNotNumber = 'Questo non 챔 un numero!';
$strNotOK = 'non OK';
...
$strPasswordChanged = 'La password per l\'utente %s 챔 cambiata con successo.';
$strPasswordEmpty = 'La password 챔 vuota!';
...
$strPHP40203 = 'Si sta utilizzando PHP 4.2.3, che presenta un serio bug con le stringhe multi-byte (mbstring). Vedi report PHP 19404. Questa versione di PHP non 챔 raccomandata per l\'utilizzo con phpMyAdmin.';
...
$strPrimaryKeyHasBeenDropped = 'La chiave primaria 챔 stata eliminata';
...
$strPrivDescMaxConnections = 'Limita il numero di nuove connessioni che un utente pu챵 aprire in un\'ora.';
$strPrivDescMaxQuestions = 'Limita il numero di query che un utente pu챵 mandare al server in un\'ora.';
$strPrivDescMaxUpdates = 'Limita il numero di comandi che possono cambiare una tabella o un database che un utente pu챵 eseguire in un\'ora.';
$strPrivDescMaxUserConnections = 'Limite di connessioni simultanee che un utente pu챵 fare.';
...
$strPrivDescSuper = 'Permette altre connessioni, anche se 챔 stato raggiunto il massimo numero di connessioni; Necessario per molte operazioni di amministrazione come il settaggio di variabili globali o la cancellazione dei threads di altri utenti.';
...
$strRecords = 'Record';
$strReferentialIntegrity = 'Controlla l\'integrit횪 delle referenze:';
$strRefresh = 'Aggiorna';
$strRelationalSchema = 'Schema relazionale';
$strRelationDeleted = 'Relazione cancellata';
$strRelationNotWorking = 'Le caratteristiche aggiuntive sono state disattivate per funzionare con le tabelle linkate. Per scoprire perch챕 clicca %squi%s.';
...
$strRenameDatabaseOK = 'Il DataBase %s 챔 stato rinominato in %s';
$strRenameTableOK = 'La tabella %s 챔 stata rinominata %s';
...
$strRevokeAndDeleteDescr = 'Gli utenti UTILIZZERANNO comunque il privilegio finch챕 i privilegi non saranno ricaricati.';
...
$strRowsModeOptions = ' in modalit횪 %s e ripeti gli headers dopo %s celle ';
...
$strSave = 'Salva';
$strScaleFactorSmall = 'Il fattore di scala 챔 troppo piccolo per riempire lo schema nella pagina';
$strSearch = 'Cerca';
...
$strSearchType = 'Trova:';
$strSecretRequired = 'Adesso c\'챔 bisogno di una password per il file di configurazione (blowfish_secret).';
...
$strSetEnumVal = 'Se il tipo di campo 챔 "enum" o "set", immettere i valori usando il formato: \'a\',\'b\',\'c\'...<br />Se comunque dovete mettere dei backslashes ("\") o dei single quote ("\'") davanti a questi valori, backslashateli (per esempio \'\\\\xyz\' o \'a\\\'b\').';
...
$strShowHideLeftMenu = 'Mostra/nascondi il men첫 di sinistra';
...
$strShowStatusCreated_tmp_disk_tablesDescr = 'Il numero delle tabelle temporanee create automaticamente sul disco dal server mentre esegue i comandi. Se il valore Created_tmp_disk_tables 챔 grande, potresti voler aumentare il valore tmp_table_size, per fare im modo che le tabelle temporanee siano memory-based anzich챔 disk-based.';
...
$strShowStatusDelayed_insert_threadsDescr = 'Il numero di processi INSERT DELAYED in uso. Ciascuna tabella su cui 챔 usato INSERT DELAYED occupa un thread.';
...
$strShowStatusHandler_deleteDescr = 'Il numero di volte in cui una riga 챔 stata cancellata da una tabella.';
$strShowStatusHandler_discoverDescr = 'Il server MySQL pu챵 chiedere al motore di storage NDB Cluster se conosce una tabella sulla base di un nome dato. Questo 챔 chaiamto discovery. Handler_discover indica il numero di volte che una tabella 챔 stata trovata.';
$strShowStatusHandler_read_firstDescr = 'Il numero di volte che il primo valore 챔 stato letto da un indice. Se 챔 troppo alto 챔 probabile che il server stia facendo molte scansioni complete degli indici; per esempio, SELECT col1 FROM foo, assumento che col1 sia indicizzata.';
$strShowStatusHandler_read_keyDescr = 'Il numero di richieste per leggere una riga basata su di una chiave. Se 챔 alta, 챔 un buon indice che le tue query e le tue tabelle sono correttamente indicizzate.';
$strShowStatusHandler_read_nextDescr = 'Il numero di richieste per leggere la riga successiva nell\'ordine delle chiavi. Questo valore 챔 incrementato se stai facendo una query su di una colonna indice con un range costante, oppure se stai facendo una scansione degli indici.';
$strShowStatusHandler_read_prevDescr = 'Il numero di richieste per leggere la riga precedente nell\'ordine delle chiavi. Questo metodo di lettura 챔 principalmente utilizzato per ottimizzare ORDER BY ... DESC.';
$strShowStatusHandler_read_rndDescr = 'Il numero di richieste per leggere una riga basata su una posizione fissa. Questo valore 챔 alto se stai facendo molte richieste che richiedono un ordinamento dei risultati. Probabilmente hai molte query che che richiedono a MySQL di leggere l\'intera tabella oppure ci sono dei joins che non usano le chiavi correttamente.';
$strShowStatusHandler_read_rnd_nextDescr = 'Il numero di richieste per leggere la riga successiva in un file di dati. Questo valore 챔 alto se stai facendo molte scansioni della tabella. Generalmente 챔 un segnale che le tue tabelle non sono correttamente indicizzate, o che le query non sono state scritte per trarre vantaggi dagli indici che hai.';
...
$strShowStatusInnodb_buffer_pool_pages_miscDescr = 'Il numero di pagine occupate perch챔 sono state allocate per amministrazione, come row locks o per hash index adattivi. Questo valore pu챵 essere calcolato come Innodb_buffer_pool_pages_total - Innodb_buffer_pool_pages_free - Innodb_buffer_pool_pages_data.';
...
$strShowStatusInnodb_buffer_pool_readsDescr = 'Il numero di richieste logiche che InnoDB non pu챵 soddisfare dal buffer pool e che devono fare una lettura di una pagina singola.';
$strShowStatusInnodb_buffer_pool_wait_freeDescr = 'Normalmente le sritture nel buffer pool InnoDB vengono effettuate in background. Tuttavia se 챔 necessario leggere o creare una pagina, e non sono disponibile pagine pulite 챔 necessario attendere che le pagine siano aggiornate prima. Questo contatore conta le istanze di queste attese. Se la dimesione del buffer pool 챔 stata settata correttamente questo valore dovrebbe essere basso.';
...
$strShowStatusInnodb_data_readDescr = 'La quantit횪 di dati letti fino ad ora, in bytes.';
...
$strShowStatusInnodb_data_writtenDescr = 'La quantit횪 di dati scritti fino ad ora, in bytes.';
...
$strShowStatusInnodb_log_waitsDescr = 'Il numero di attese che abbiamo avuto perch챔 il buffer di log era troppo piccolo e abbiamo duvuto attendere che fosse aggiornato prima di continuare.';
...
$strShowStatusKey_blocks_unusedDescr = 'Il numero di blocchi non usati nella cache chiave. Puoi usare questo valore per determinare quanta cache chiave 챔 in uso.';
$strShowStatusKey_blocks_usedDescr = 'Il numero di blocchi usati nella cache chiave. The number of used blocks in the key cache. Questo valore 챔 un\'importante segnale che indica il numero massimo di blocchi che sono stati in uso contemporaneamente.';
$strShowStatusKey_read_requestsDescr = 'Il numero di richieste per le ggere un blocco chiave dalla cache.';
$strShowStatusKey_readsDescr = 'Il numero di letture fisiche dal disco di un blocco chiave. Se Key_reads 챔 grande allora il valore key_buffer_size 챔 probabilmente troppo piccolo. IIl rapporto di cache miss rate pu챵 essere calcolato come Key_reads/Key_read_requests.';
...
$strShowStatusLast_query_costDescr = 'Il costo totale dell\'ultima query compilata cos챙 come computato dall\'ottimizzatore delle query. Utile per comparare il costo di differenti query per la stessa operazione di query. Il valore di default 챔 0, che significa che nessuna query 챔 stata ancora compilata.';
$strShowStatusNot_flushed_delayed_rowsDescr = 'In numero di righe in attesa di essere scritte nella coda INSERT DELAYED.';
$strShowStatusOpened_tablesDescr = 'Il numero di tabelle che sono state aperte. Se il valore opened_tables 챔 grande, probabilmente il valore di table cache 챔 troppo piccolo.';
...
$strShowStatusQcache_lowmem_prunesDescr = 'Il numero di query che sono state rimosse dalla cache per liberare memoria per la cache di nuove query. Questa informazione pu챵 aiutarti per parametrare la dimensione della cache delle query. La cache delle query usa una strategia di "meno usate recentemente" (LRU - least recently used) per decidere quali query rimuovere dalla cache.';
$strShowStatusQcache_not_cachedDescr = 'Il numero di query non in cache (impossibilit횪 di inserirle nella cache oppure non inserite per i settaggi del parametro query_cache_type).';
...
$strShowStatusSelect_full_joinDescr = 'Il numero di joins che non usano gli indici. (Se questo valore non 챔 0, dovresti controllare attentamente gli indici delle tue tabelle.)';
...
$strShowStatusSelect_range_checkDescr = 'Il numero di joins senza chiavi che controllano per l\'uso di una chiave dopo ogni riga. (Se questo valore non 챔 0, dovresti controllare attentamente gli indici delle tue tabelle.)';
$strShowStatusSelect_rangeDescr = 'Il numero di joins che usano un range sulla prima tabella. (Non 챔, solitamente, un valore critico anche se 챔 grande.)';
...
$strShowStatusSlave_runningDescr = 'Questa chiave 챔 ON se questo 챔 un server slave connesso ad un server master.';
$strShowStatusSlow_launch_threadsDescr = 'Numero di processi che hanno impiegato pi첫 di "slow_launch_time" secondi per partire.';
$strShowStatusSlow_queriesDescr = 'Numero di query che hanno impiegato pi첫 di "long_query_time" seconds.';
$strShowStatusSort_merge_passesDescr = 'Il numero di fusioni passate all\'algoritmo di ordianemento che sono state fatte. Se questo valore 챔 grande, dovresti incrementare la variabile di sistema sort_buffer_size.';
...
$strShowStatusTable_locks_immediateDescr = 'Il numero di volte che un table lock 챔 stato eseguito immediatamente.';
$strShowStatusTable_locks_waitedDescr = 'Il numero di volte che un table lock 챔 stato eseguito immediatamente ed era necessaria un\'attesa. Se 챔 alto, potresti avere dei problemi con le performance, dovresti prima ottimizzare le query, oppure sia utilizzare le repliche, sia dividere le tabelle.';
$strShowStatusThreads_cachedDescr = 'Il numero dei processi nella cache dei processi. L\'hit rate della cache pu챵 essere calcolato come processi_creati/connessioni. Se questo valore 챔 rosso devi aumentare la tua thread_cache_size.';
$strShowStatusThreads_connectedDescr = 'Il numero di connessioni correntemente aperte.';
$strShowStatusThreads_createdDescr = 'Il numero di processi creati per gestire le connessioni. Se Threads_created 챔 grosso, devi probabilmente aumentare il valore thread_cache_size. (Normalmente questo non fornisce un significatico incremento delle performace se hai una buona implementazione dei processi.)';
...
$strSocketProblem = '(o il socket del server locale MySQL non 챔 correttamente configurato)';
...
$strSQLCompatibility = 'Modo di compatibilit횪 SQL';
$strSQLExportType = 'Tipo di esportazione';
$strSQLParserBugMessage = 'C\'챔 la possibilit횪 che ci sia un bug nel parser SQL. Per favore, esaminate la query accuratamente, e controllate che le virgolette siano corrette e non sbagliate. Altre possibili cause d\'errori possono essere che si stia cercando di uploadare un file binario al di fuori di un\'area di testo virgolettata. Si pu챵 anche provare la query MySQL dalla riga di comando di MySQL. L\'errore qui sotto restituito dal server MySQL, se ce n\'챔 uno, pu챵 anche aiutare nella diagnostica del problema. Se ci sono ancora problemi, o se il parser SQL di phpMyAdmin sbaglia quando invece l\'interfaccia a riga di comando non mostra problemi, si pu챵 ridurre la query SQL in ingresso alla singola query che causa problemi, e inviare un bug report con i dati riportati nella sezione CUT qui sotto:';
$strSQLParserUserError = 'Pare che ci sia un errore nella query SQL immessa. L\'errore del server MySQL mostrato qui sotto, se c\'챔, pu챵 anche aiutare nella risoluzione del problema';
...
$strSubmit = 'Invia';
$strSuccess = 'La query 챔 stata eseguita con successo';
$strSuhosin = 'Sul server 챔 in esecuzione Suhosin. Controlla la documentazione: %sdocumentation%s per possibili problemi.';
$strSum = 'Totali';
$strSwedish = 'Svedese';
$strSwitchToDatabase = 'Passare al Database copiato';
$strSwitchToTable = 'Passa alla tabella copiata';

$strTableAlreadyExists = 'La tabella %s esiste gi횪!';
$strTableComments = 'Commenti sulla tabella';
$strTableEmpty = 'Il nome della tabella 챔 vuoto!';
$strTableHasBeenDropped = 'La tabella %s 챔 stata eliminata';
$strTableHasBeenEmptied = 'La tabella %s 챔 stata svuotata';
$strTableHasBeenFlushed = 'La tabella %s 챔 stata inizializzata';
...
$strTextAreaLength = ' A causa della sua lunghezza,<br /> questo campo non pu챵 essere modificato ';
$strThai = 'Thai';
...
$strThreads = 'Processi';
$strThreadSuccessfullyKilled = 'Il thread %s 챔 stato terminato con successo.';
$strTimeoutInfo = 'Una precedente importazione 챔 entrata in timeout, dopo un nuovo inoltro riprender횪 dalla posizione: %d.';
$strTimeoutNothingParsed = 'Nell\'ultima esecuzione nessun dato 챔 stato processato, questo, solitamente, vuole dire che che phpMyAdmin non 챔 in grado di ultimare l\'operazione fino a che non verr횪 aumentato il parametro php time limits.';
$strTimeoutPassed = 'Superato il tempo limite dello script, se vuoi finire l\'importazione inoltra nuovamente il file e il processo riprender횪.';
$strTime = 'Tempo';
...
$strTransformation_application_octetstream__download = 'Visualizza un collegamento per trasferire i dati di un campo in formato binario.  La prima opzione 챔 il nome del file binario.  La seconda opzione 챔 un nome di campo possibile di una riga della tabella che contiene il nome di schedario.  Se fornite una seconda opzione dovete avere la prima opzione settata ad una stringa vuota';
...
$strTransformation_text_plain__dateformat = 'Mostra i campi TIME, TIMESTAMP, DATETIME o il TIMESTAMP UNIX come data formattata. La prima opzione 챔 l\'offset (in ore) che verr횪 aggiunto all\'ora (Default: 0). Usare la seconda opzione per specificare un differente formato di data/ora. La terza opzione determina se vuoi vedere l\'ora locale o UTC (usa "local" o "utc" per questo). In relazione a questo, il formato data ha differenti valori - per "local" guarda la documentazione della funzione PHP strftime(); per "utc" viene usata la funzione gmdate().';
$strTransformation_text_plain__external = 'SOLO PER LINUX: Lancia un\'applicazione esterna e riempie i dati dei campi tramite lo standard input. Restituisce lo standard output dell\'applicazione. L\'impostazione predefinita 챔 Tidy, per stampare in maniera corretta il codice HTML. Per motivi di sicurezza, dovete editare manualmente il file libraries/transformations/text_plain__external.inc.php e inserire gli strumenti che permettete di utilizzare. La prima opzione 챔 cos챙 il numero del programma che volete utilizzare e la seconda sono i parametri per il programma. Il terzo parametro, se impostato a 1 convertir횪 l\'output utilizzando htmlspecialchars() (Predefinito: 1). Un quarto parametro, se impostato a 1 inserir횪 un NOWRAP al contenuto della cella cos챙 che l\'intero output sar횪 mostrato senza essere riformattato (Predefinito: 1)';
$strTransformation_text_plain__formatted = 'Preserva l\'originale formattazione del campo. Nessun Escaping viene applicato.';
$strTransformation_text_plain__imagelink = 'Mostra un collegamento ad una immagine esterna; il campo contiene il nome del file; la prima opzione 챔 un prefisso come "http://tuodominio.com/", la seconda opzione 챔 la larghezza in pixel, la terza 챔 l\'altezza.';
$strTransformation_text_plain__link = 'Mostra un collegamento, il campo contiene il nome del file; la prima opzione 챔 un prefisso come "http://tuodominio.com/", la seconda opzione 챔 un titolo per il collegamento.';
$strTransformation_text_plain__sql = 'Formatta il testo come query SQL con evidenziazione della sintassi.';
$strTransformation_text_plain__substr = 'Mostra soltanto una parte della stringa. La prima opzione 챔 l\'offset che serve a definire dove inizia l\'output del vostro testo (Prefinito: 0). La seconda opzione 챔 un offset che indica quanto testo viene restituito. Se vuoto, restituisce tutto il testo rimanente. La terza opzione definisce quali caratteri saranno aggiunti in fondo all\'output quando una soptto-stringa viene restituita (Predefinito: ...) .';
...
$strUnsupportedCompressionDetected = 'Stai cercando di importare un file con un tipo di compressione non supportato. Altrimenti il supporto per questo tipo di compressione non 챔 stato ancora implementato o 챔 stato disabilitato dalla tua configurazione.';
$strUpdatePrivMessage = 'Hai aggiornato i permessi per %s.';
$strUpdateProfileMessage = 'Il profilo 챔 stato aggiornato.';
...
$strUploadErrorPartial = 'Il file 챔 stato solo parzialmente caricato.';
...
$strUploadsNotAllowed = 'Non 챔 permesso l\'upload dei file su questo server.';
$strUsage = 'Utilizzo';
...
$strUserAlreadyExists = 'L\'utente %s esiste gi횪!';
$strUserEmpty = 'Il nome utente 챔 vuoto!';
$strUserName = 'Nome utente';
$strUserNotFound = 'L\'utente selezionato non 챔 stato trovato nella tabella dei privilegi.';
...
$strValidatorError = 'L\' SQL validator non pu챵 essere inizializzato. Prego controllare di avere installato le estensioni php necessarie come descritto nella %sdocumentazione%s.';
$strValue = 'Valore';
$strVar = 'Variabile';
...
$strViewHasBeenDropped = 'La vista %s 챔 stata eliminata';
$strViewMaxExactCount = 'Questa vista ha pi첫 di %d righe. Per informazioni fare riferimento a %sdocumentation%s.';
$strViewName = 'Nome VISTA';
$strView = 'Vista';

$strWebServerUploadDirectory = 'directory di upload del web-server';
$strWebServerUploadDirectoryError = 'La directory impostata per l\'upload non pu챵 essere trovata';
$strWelcome = 'Benvenuto in %s';
$strWestEuropean = 'Europeo Occidentale';
$strWildcard = 'wildcard';
$strWindowNotFound = 'La finestra destinataria del browser non pu챵 essere aggiornata. Pu챵 darsi che sia stata chiusa la finestra madre o che il vostro browser stia bloccando gli aggiornamenti fra browsers a causa di qualche impostazione di sicurezza';
