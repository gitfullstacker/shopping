...
<body onload="jsf__chk_type();init_orderid();chk_pay();kcp_AJAX();" style="display: none;">
    <div class="wrap">
            ...
            <div id="skipCont" class="contents">
                ...
                <ul class="list-type-1">
                    ...
                    <li>
                        ...
                        <div class="right">
                            <div class="ipt-type-1 pc-wd-2">
                                <input type="text" name="good_name" value="<?= iconv('UTF-8', 'EUC-KR', $_POST['good_name']) ?>" />
                                <a href="#none" class="btn-clear"></a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class="right">
                            <div class="ipt-type-1 gap-2 pc-wd-2">
                                <input type="text" name="good_mny" value="<?= iconv('UTF-8', 'EUC-KR', $_POST['good_mny']) ?>" maxlength="9" />
                                <a href="#none" class="btn-clear"></a>
                ...
                <ul class="list-type-1">
                    ...
                    <li>
                        ...
                        <div class="right">
                            <div class="ipt-type-1 pc-wd-2">
                                <input type="text" name="buyr_name" value="<?= iconv('UTF-8', 'EUC-KR', $_POST['buyr_name']) ?>" />
                                <a href="#none" class="btn-clear"></a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class="right">
                            <div class="ipt-type-1 pc-wd-2">
                                <input type="text" name="buyr_tel1" value="<?= iconv('UTF-8', 'EUC-KR', $_POST['buyr_tel1']) ?>" />
                                <a href="#none" class="btn-clear"></a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class="right">
                            <div class="ipt-type-1 pc-wd-2">
                                <input type="text" name="buyr_tel2" value="<?= iconv('UTF-8', 'EUC-KR', $_POST['buyr_tel2']) ?>" />
                                <a href="#none" class="btn-clear"></a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class="right">
                            <div class="ipt-type-1 pc-wd-2">
                                <input type="text" name="buyr_mail" value="<?= iconv('UTF-8', 'EUC-KR', $_POST['buyr_mail']) ?>" />
                                <a href="#none" class="btn-clear"></a>
                            </div>
                        </div>
                    </li>
