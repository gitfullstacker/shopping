...
<? require_once $_SERVER['DOCUMENT_ROOT']."/inc/header.php"; ?>
		...
		<div id="container">
		 ...
		 <div id="container">
			...
			<div class="sub_container" style="height:250px;" >
				<div class="contents_w">
					<div>
						<div id="guide01">
<a href="tel:01095356733"><img src="../images/change/cscenterimage1.png" alt=""/></a>
						</div>	
						
						<div style="float:left;width:50%;">
								<a href="/mypage/my_qna.php"><img src="../images/change/cscenterimage2.png" alt="" /></a>
						</div>
						<div style="float:right;width:50%;">
						 		<a href="http://pf.kakao.com/_eZdId"><img src="../images/change/cscenterimage3.png" alt="" /></a>
						</div>		
