<?
    ...
    $g_conf_home_dir  = $_SERVER['DOCUMENT_ROOT']."/payment/windows/auto_pay";              // 절대경로 입력
    $g_conf_key_dir   = $_SERVER['DOCUMENT_ROOT']."/payment/windows/auto_pay/bin/pub.key";  // pub.key 파일의 경로 입력(파일명까지 입력)
    $g_conf_log_dir   = $_SERVER['DOCUMENT_ROOT']."/payment/windows/auto_pay/bin/log";          // log 절대경로 입력
