<?
    ...
    $g_conf_home_dir  = $_SERVER['DOCUMENT_ROOT']."/payment/linux/auto_pay";
    ...
    /* =   log 경로 지정                                                            = */
    /* ============================================================================== */
    $g_conf_log_path = $_SERVER['DOCUMENT_ROOT']."/payment/linux/auto_pay/bin/log";
    ...
    /* =                                                                            = */
    /* = * g_conf_site_name 설정                                                    = */
    /* = 사이트명 설정(특수문자 불가) : 표준웹 결제창 오른쪽 상단에 표기되는 값입니다.             = */
