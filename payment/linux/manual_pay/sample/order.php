        ...
        <form name="order_info" method="post" action="./pp_cli_hub.php" style="display: none;">
            ...
            <div id="skipCont" class="contents">
                ...
                <ul class="list-check-1">
                    <li>
                        <input type="radio" id="radio-2-1" class="ipt-radio-1" name="pay_method" value="100000000000" <?= $_POST['card_type'] == '1' ? 'checked' : '' ?> />
                    ...
                    <li>
                        <input type="radio" id="radio-2-3" class="ipt-radio-1" name="pay_method" value="001000000000" <?= $_POST['card_type'] == '2' ? 'checked' : '' ?> />
