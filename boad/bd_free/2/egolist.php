													...
													<tr>
														<td align="center" colspan="4" style="padding:0px;border-bottom:0px;padding-top:5px;">
															<table width="100%" border="0" cellpadding="0" cellspacing="2">
																...
																?>
																	<tr>
																		<td style="padding:0px;border-bottom:0px;"><img src="<?= $str_Board_Icon_Img ?>ic_pen.gif" align="absMiddle">
																			<font color="#000000"><b><?= Fnc_Conv_View(mysql_result($arr_File_Data, $int_J, F_TITLE), 0) ?></b></font>
																		</td>
																	</tr>
																<?
																}
																...
																?>
																	<tr>
																		<td style="padding:0px;border-bottom:0px;">
																			<font color="#000000"><?= Fnc_Conv_View(mysql_result($arr_File_Data, $int_J, F_CONT), 0) ?></font>
																		</td>
																	</tr>
																<?
																}
