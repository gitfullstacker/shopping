...
<?
	...
	$arr_Set_Data[21]	= 0;
	$arr_Set_Data[22]	= 0;
	$arr_Set_Data[23]	= Fnc_Om_Conv_Default($_REQUEST[str_goodcode],"");
...
<!--
	<?If ($int_Ini_Board_Seq>0 && $int_Bd_Seq==0 && strlen($arr_Set_Data[0])==21) {?>
		document.location.replace("egoread.php?bd=<?=$int_Ini_Board_Seq?>&seq=<?=$int_Set_Seq?>");
	<?}else{?>
