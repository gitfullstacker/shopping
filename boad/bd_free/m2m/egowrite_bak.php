				...
				<table class="t_type">
					...
					<tbody>
						...
						<tr>
							<th>이용가방</th>
							<td class="center">
								<p><?if ($arr_Data['STR_IMAGE1']!=""){?><img src="/admincenter/files/good/<?=$arr_Data['STR_IMAGE1']?>" alt=""  class="t_img"/><?}else{?>&nbsp;<?}?></p>
								<p class="f_bk f_bd mt07"><?=$arr_Data['STR_CODE']?></p>
								<p class="mt05"><?=$arr_Data['STR_GOODNAME']?></p>
							</td>
						</tr>
						<tr>
							<th>아이디</th>
						...
						<tr>
							...
							<td>
								<?
									...
									If ($arr_Get_Data[0][9]=="") {
								?>
								<input type="text" name="txt_Name" maxlength="20" value="" class="inp w100p">
								<?
									}Else{
								?>
						...
						<tr>
							...
							<td>
								<ul class="sc_list">
									<li>
										<label>
											<input type="radio" value="1" name="txt_item2" class="null cform" <?If ($arr_Get_Data[0][20]=="5") {?> checked<?}?>>
									...
									<li>
										<label>
											<input type="radio" value="2" name="txt_item2" class="null cform" <?If ($arr_Get_Data[0][20]=="4") {?> checked<?}?>>
									...
									<li>
										<label>
											<input type="radio" value="3" name="txt_item2" class="null cform" <?If ($arr_Get_Data[0][20]=="3") {?> checked<?}?>>
									...
									<li>
										<label>
											<input type="radio" value="4" name="txt_item2" class="null cform" <?If ($arr_Get_Data[0][20]=="2") {?> checked<?}?>>
									...
									<li>
										<label>
											<input type="radio" value="5" name="txt_item2" class="null cform" <?If ($arr_Get_Data[0][20]=="1") {?> checked<?}?>>
						...
						<tr>
							<th>제목</th>
							<td>
								<input type="text" name="txt_Subject" maxlength="200" value="" class="inp w100p">
								<SCRIPT LANGUAGE="JavaScript">
								<!--
						...
						<tr>
							...
							<td style="height:100px;">
								<textarea name="mtx_Content" id="mtx_Content" rows="10" cols="10" style="width:100%; height:400px; display:none;"><?php echo stripslashes($arr_Get_Data[0][13]); ?></textarea>
