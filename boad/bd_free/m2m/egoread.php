...
<?include "inc/inc_mid.php";?>
				...
				<table class="t_type">
					...
					<tbody>
						<tr>
							<th>이용가방</th>
							<td class="center">
								<p><?if ($arr_Get_Data[0][23]!=""){?><img src="/admincenter/files/good/<?=$arr_Get_Data[0][23]?>" class="t_img" alt="" /><?}else{?>&nbsp;<?}?></p>
								<p class="f_bk f_bd mt07"><?=$arr_Get_Data[0][24]?></p>
								<p class="mt05"><?=$arr_Get_Data[0][22]?></p>
							</td>
						</tr>
						<tr>
							<th>아이디</th>
							<td><?=$arr_Get_Data[0][4]?></td>
						</tr>
						<tr>
							<th>성명</th>
							<td>
						...
						<tr>
							<th>만족도</th>
							<td>
								<?if ($arr_Get_Data[0][20]=="1"){?><i class="icn icn_star01"></i><i class="icn icn_star00"></i><i class="icn icn_star00"></i><i class="icn icn_star00"></i><i class="icn icn_star00"></i><?}?>
								<?if ($arr_Get_Data[0][20]=="2"){?><i class="icn icn_star01"></i><i class="icn icn_star01"></i><i class="icn icn_star00"></i><i class="icn icn_star00"></i><i class="icn icn_star00"></i><?}?>
								<?if ($arr_Get_Data[0][20]=="3"){?><i class="icn icn_star01"></i><i class="icn icn_star01"></i><i class="icn icn_star01"></i><i class="icn icn_star00"></i><i class="icn icn_star00"></i><?}?>
								<?if ($arr_Get_Data[0][20]=="4"){?><i class="icn icn_star01"></i><i class="icn icn_star01"></i><i class="icn icn_star01"></i><i class="icn icn_star01"></i><i class="icn icn_star00"></i><?}?>
								<?if ($arr_Get_Data[0][20]=="5"){?><i class="icn icn_star01"></i><i class="icn icn_star01"></i><i class="icn icn_star01"></i><i class="icn icn_star01"></i><i class="icn icn_star01"></i><?}?>
							</td>
						</tr>
						<tr>
							<th>제목</th>
							<td><?=stripslashes($arr_Get_Data[0][8])?></td>
						</tr>
						<tr>
							<th>내용</th>
							<td>
			...
			<div class="btn_w mt15" style="padding-bottom:15px;">
				<p class="fl3_1">
					...
					<?}?>
					<a href="#;" style="cursor:pointer;" onclick="fnc_Send_Data(document.frm_Send, 1);" class="btn btn_l btn_ylw f_bd w100p">수정하기</a></p>
				<p class="fl3_2"><a href="#;" style="cursor:pointer;" onclick="fnc_Send_Data(document.frm_Send, 0);" class="btn btn_l btn_bk f_bd w100p">삭제</a></p>
				<p class="fl3_3"><a href="egolist.php<?=$str_String?>" class="btn btn_l btn_bk f_bd w100p">목록</a></p>
			</div>
