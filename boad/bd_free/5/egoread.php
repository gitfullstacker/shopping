...
<?include "inc/inc_mid.php";?>
					...
					<table class="board_view_info">
						<tr>
							<th style="width:15%" class="tit">작성자</th>
							<td style="width:35%">
								<?
									$str_Tmp = "";
							...
							<th style="width:15%" class="tit">작성일</th>
							<td style="width:35%"><?=$arr_Get_Data[0][13]?></td>
						</tr>
						<tr>
					...
					<div class="board_button">
							...
							<?}?>
                        	<img src="/images/board/btn_modify.jpg" style="cursor:pointer;" onclick="fnc_Send_Data(document.frm_Send, 1);" align="absmiddle" alt="edit"> 
                        	<img src="/images/board/btn_del.jpg" style="cursor:pointer;" onclick="fnc_Send_Data(document.frm_Send, 0);" align="absmiddle" alt="delete"> 
							</div>
							<div style="float:right;">
								...
								?>
									<a href="egowrite.php<?=$str_String."&seq=".$int_Bd_Seq?>" class="lnk0"><img src="/images/board/btn_write.jpg" align="absmiddle"></a>
									<?
										// ======================================
										//	= 답변 글쓰기 버튼 출력 시작
										If ($arr_Ini_Board_Info[0][9]==1) {
									?>
									<a href="egowrite.php<?=$str_String."&seq=".$int_Bd_Seq."&mode=2"?>"><img src="/images/board/btn_reply.jpg" align="absmiddle"></a>
									<?
										}
										//	= 답변 글쓰기 버튼 출력 종료
										// ======================================
								...
								<?
									...
									// &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
								?>
                        	<a href="egolist.php<?=$str_String?>"><img src="/images/board/btn_list.jpg" alt="목록" align="absmiddle" /></a>
							</div>
