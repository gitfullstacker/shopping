...
<?include "inc/inc_mid.php";?>
				...
				<input type="hidden" name="txt_Mem_Id" value="<?=$arr_Get_Data[0][8]?>">
					...
					<table border="0" cellspacing="0" cellpadding="0" class="board_write" align="center">
						<tbody>
						<tr>
							<th>작성자</th>
							<td>
						...
						<tr>
							<th>이메일</th>
							<td>
								<input name="txt_Email" type="text" style="width:161px;" class="board_input" value="<?=$arr_Get_Data[0][10]?>">
							</td>
						</tr>		
						<tr class="write_bgnone">
							<th>제 목</th>
							<td>
								<input type="text" name="txt_Subject" style="width:470px;" maxlength="200" value="" class="board_input">
								<SCRIPT LANGUAGE="JavaScript">
								<!--
						...
						<tr>
							<th>글암호</th>
							<td>
								<input type="password" class="board_input" name="txt_Pwd" style="width:80px;" maxlength="20">
							</td>
						</tr>	
						<?
							}
						...
						<tr class="write_bgnone">
							<th class="write_file_head">파일선택</th>
							<td class="write_file_input" id="lbl_File_Re_Write"><input type="file" class="board_f_select" name="fil_File_Data" style="width:265px;" /></td>
						</tr>
						<tr class="write_bgnone" style="display:none;">
							<th class="write_file_head">file name</th>
							<td class="write_file_input"><input name="txt_File_Subject" type="text" style="width:265px;" class="board_input"></td>
						</tr>
						<tr class="write_bgnone">
							<th class="write_file_head"></th>
							<td class="write_file_input">
								<textarea class="textarea" name="mtx_File_Content" class="border_1"wrap="soft" cols="67" rows="2" style="display:none;"></textarea>
								<img src="<?=$str_Board_Icon_Img?>btn_file_save.gif" align="absMiddle" style="cursor:pointer;" onclick="fnc_Image_Save('frm_Send', 'lbl_File_Add_Brow', 'sel_Att_File', 0);">
								<img src="<?=$str_Board_Icon_Img?>btn_file_del.gif" align="absMiddle" style="cursor:pointer;" onclick="fnc_Image_Save('frm_Send', 'lbl_File_Add_Brow', 'sel_Att_File', 2);">
							</td>
						</tr>
						<tr class="write_bgnone">
							<th class="write_file_head">첨부리스트</th>
							<td class="write_file_input">
						...
						?>
						<tr class="write_bgnone">
							<th class="write_file_head">파일사용량</th>
							<td class="write_file_input"><span id="lbl_File_Use_Graph"></span></td>
                        </tr>
						<?
							// ==========================================
							//	= 파일 사용량 출력 시작
					...
					<div class="board_button">
						<img src="/images/board/btn_ok.jpg" alt="확인" style="cursor:pointer;" onclick="fnc_Eb_Send(document.frm_Send, 'mtx_Content');">
						<img src="/images/board/btn_cancel.jpg" alt="취소" style="cursor:pointer;" onclick="fnc_Eb_Cancel(document.frm_Send);">
					</div>
