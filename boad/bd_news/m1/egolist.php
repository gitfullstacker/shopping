...
<?include "inc/inc_mid.php";?>
	...
	<input type="hidden" name="mode" value="99">
			...
			<p class="f_size_s mt15">총 <?=$int_Total_Cnt?>개의 공지사항이 있습니다.</p>
			<div class="t_cover01 mt05">
				<ul class="boad_list">
					...
					?>
					<li>
						<span class="date"><?=str_replace("-", ".",substr(mysql_result($arr_Notice_Data,$int_I,bd_reg_date),0,10))?></span>
						<a href="egoread.php<?=$str_String.$str_Pg?>&seq=<?=mysql_result($arr_Notice_Data,$int_I,bd_seq)?>" class="tit">						
						<?
							// &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
					...
					<li>
						<span class="date"><?=str_replace("-", ".",substr(mysql_result($arr_Get_Data,$int_I,bd_reg_date),0,10))?></span>
						<a href="egoread.php<?=$str_String.$str_Pg?>&seq=<?=mysql_result($arr_Get_Data,$int_I,bd_seq)?>" class="tit">
						<?
						// &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
							//	= 답변글이라면 답변글 계층 표시 시작
