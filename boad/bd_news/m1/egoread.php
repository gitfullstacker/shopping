...
<?include "inc/inc_mid.php";?>
			...
			<div class="t_cover01  ">
				<div class="bd_view_tit"><?=stripslashes($arr_Get_Data[0][8])?></div>
				<div class="bd_view_con"><?=str_replace("-",".",substr($arr_Get_Data[0][13],0,10))?></div>
				<div class="bd_view_con">
					<?
						// ========================================
			...
			<div class="btn_w mt10" style="margin-bottom: 15px;">
				<p class="fl3_1"><a href="egolist.php<?=$str_String?>" class="btn btn_ml btn_gray02 w100p ">목록</a></p>
				<?if($arr_Prev_Data_Cnt || $arr_Next_Data_Cnt){?>
				<?if($arr_Next_Data_Cnt){?>
				<p class="fl3_2"><a href="egoread.php<?=$str_String?>&seq=<?=mysql_result($arr_Next_Data,0,BD_SEQ)?>" class="btn btn_ml btn_gray02 w100p ">윗글</a></p>
			  	<?}?>
		      	<?if($arr_Prev_Data_Cnt){?>
				<p class="fl3_3"><a href="egoread.php<?=$str_String?>&seq=<?=mysql_result($arr_Prev_Data,0,BD_SEQ)?>" class="btn btn_ml btn_gray02 w100p ">아랫글</a></p>
				<?}?>
				<?}?>
			</div>
