...
<?include "inc/inc_mid.php";?>
					...
					<div class="t_cover01 mt30">
						<table class="t_type01">
							...
							<thead>
								<tr>
									<th colspan="2" class="left"><?=stripslashes($arr_Get_Data[0][8])?></th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td class="left"><?=str_replace("-",".",substr($arr_Get_Data[0][13],0,10))?></td>
									<td class="right">
										<?
											// ========================================
					...
					<div class="right mt20"><a href="egolist.php<?=$str_String?>" class="btn btn_m btn_bk w95"><i class="icn icn_list"></i> 목록</a></div>
						...
						<table class="t_type01">
							...
							<tbody>
								...
								<tr>
									...
									<td class="center"><?=str_replace("-",".",substr(mysql_result($arr_Next_Data,0,BD_REG_DATE),0,10))?></td>
								</tr>
							  	<?}?>
								...
								<tr>
									...
									<td class="center"><?=str_replace("-",".",substr(mysql_result($arr_Prev_Data,0,BD_REG_DATE),0,10))?></td>
								</tr>
								<?}?>
							</tbody>
						</table>
