...
<?include "inc/inc_mid.php";?>
	...
	<input type="hidden" name="mode" value="99">
				...
				<div id="product">
					...
					<div>Neosem's memory test systems are available in numerous and scalable configurations for <br />
					Flash memory engineering and manufacturing test that support the testing of various<br />
					memory devices and Flash card form factors.</div>
							...
							<li>
									...
									<?
										...
										If (left($arr_New_Date[0][0],10)==left(mysql_result($arr_Get_Data,$int_I,bd_reg_date),10)) {
											//echo "<img src='".$str_Board_Icon_Img."ic_new.gif' align='absMiddle' style='width:23px;height:11px;border:0px;' border='0'> ";
										}
										//	= 새글표시 종료
										// &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
									?>
				...
				<div id="gallery">
					<ul>
								...
								<li>
									...
									?>
									<img src="egofiledata.php?bd=<?=mysql_result($arr_Get_Data,$int_I,conf_seq)?>&iseq=<?=mysql_result($arr_Get_Data,$int_I,img_seq)?>&ikey=<?=mysql_result($arr_Get_Data,$int_I,img_id_key)?>&tp=1" align="absMiddle" style="width:209px;height:167px;" border="0">
									<?
										}Else{
									?>
									<img src="/kor/images/board/img.jpg" style="width:100%;" style="width:209px;height:167px;"/>
									<?
										}
										//	= 이미지 출력 종료
										// &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
				...
				<div class="board_search">
					<fieldset>
						...
						<input type="text" class="int" maxlength="20" value="<?=$str_Txt?>" />
						<input type="image" src="/kor/images/board/btn_search_board.gif" alt="검색" title="검색" />
					</fieldset>
				</div>
